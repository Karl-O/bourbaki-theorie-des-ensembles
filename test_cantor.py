...
"""
from formule import (var, egal, et, impl, non, appartient, inclus, equiv)
import ensembles_abrege as E
import ensembles_cantor as C
from ensembles_cardinaux import (est_injection_de, inf_egal_card, est_bijection_de,
