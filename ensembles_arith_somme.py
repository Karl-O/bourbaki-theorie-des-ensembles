...
from formule import (Terme, var, egal, et, impl, appartient, existe, subst_t)
...
from ensembles_somme_commute import eq_somme_commute
...
def somme_cardinale_zero_neutre(b="B"):
    ...
    from ensembles_somme_zero import card_somme_zero_neutre
...
def somme_cardinale_associative(a="A", b="B", c="C"):
    ...
    from ensembles_somme_associe import somme_cardinale_associative as _assoc
    return _assoc(a, b, c)
