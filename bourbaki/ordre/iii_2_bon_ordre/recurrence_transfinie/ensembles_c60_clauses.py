...
def couverture_segment_realise(vh, e="E", G="G", x="x0", V="Vval", y="ytf",
    ...
    from bourbaki.logique.i_1_termes_relations.formule import inclus, non, ou
    from bourbaki.ensembles.ii_1_axiomes_algebre.ensembles_theoremes import _instance_reunion
    from bourbaki.logique.i_2_criteres_C.tactiques.tactiques_abrege2 import cas, antecedent_consequent
    R = _graphe_R(G)
    ve, vx = _t(e), var(x)
    Dx = Dfam_real(vh, e, G, vx, V)
    Ux = union_famille(Dx)
