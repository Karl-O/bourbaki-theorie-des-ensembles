...
from bourbaki.logique.i_1_termes_relations.formule import Terme, var, pourtout, impl, et
...
from bourbaki.cardinaux.iii_3_equipotence_cardinaux.somme_produit_bornes.ensembles_eq_exposant_invariant import eq_exposant_invariant
