...
from bourbaki.cardinaux.arithmetique.iii_3_4_prop8_successeur.prop8_coeur._marqueurs import (
...
def _z_in_image_h(a, b, z, h):
    ...
    vu, vz = var("u"), z
    # u∈A⊔{∅}  (A×{0}⊂A⊔{∅})
    from bourbaki.cardinaux.arithmetique.iii_3_4_prop8_successeur.prop8_coeur._incl import A0_inclus_AS
