...
def somme_cardinale_zero_neutre(b="B"):
    ...
    from bourbaki.cardinaux.arithmetique.ensembles_somme_zero import card_somme_zero_neutre
...
def somme_cardinale_associative(a="A", b="B", c="C"):
    ...
    from bourbaki.cardinaux.arithmetique.ensembles_somme_associe import somme_cardinale_associative as _assoc
    return _assoc(a, b, c)
