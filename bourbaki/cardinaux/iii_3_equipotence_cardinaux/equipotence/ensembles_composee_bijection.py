...
from bourbaki.logique.i_1_termes_relations.formule import var, egal, et, impl, Terme
...
from bourbaki.cardinaux.iii_3_equipotence_cardinaux.equipotence.ensembles_bijection import (composee_fonctionnelle,
