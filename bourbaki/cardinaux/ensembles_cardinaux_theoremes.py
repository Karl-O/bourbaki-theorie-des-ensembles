...
from bourbaki.cardinaux.ensembles_cardinaux import equipotent, cardinal, est_injection_de, inf_egal_card
from bourbaki.cardinaux.ensembles_equipotence import (equipotence_reflexive, diagonale_fonctionnelle,
                                   diagonale_domaine, diagonale_injective, diagonale_image)
from bourbaki.cardinaux.ensembles_bijection import equipotence_symetrique, equipotence_transitive
