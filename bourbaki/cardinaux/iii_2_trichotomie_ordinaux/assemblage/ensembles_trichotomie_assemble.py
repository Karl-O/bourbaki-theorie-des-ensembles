...
from bourbaki.logique.i_1_termes_relations.formule import Terme, var, egal, ou, appartient
...
from bourbaki.cardinaux.iii_2_trichotomie_ordinaux.maximalite import ensembles_maximalite_close as MAX
