...
from bourbaki.cardinaux.iii_3_equipotence_cardinaux.cantor_bernstein.ensembles_cantor_bernstein import inclusion_transitive_terme
...
from bourbaki.cardinaux.iii_2_trichotomie_ordinaux.coincidence_fusion.ensembles_fusion_depuis_coincidence_app import _DISCHARGEABLE
...
def restriction_inclus_produit_Tp(phip="phip", phig="phig", Sp="Sp", Tp="Tp",
    ...
    from bourbaki.cardinaux.iii_2_trichotomie_ordinaux.temoins_comparabilite.ensembles_codomaine_reconciliation import codomaine_egal_image
...
def _residu_consequent_prouve(E_set, R, F_set, Rp, Sp, Tp, phip, Sg, Tg, phig):
    ...
    from bourbaki.cardinaux.iii_2_trichotomie_ordinaux.temoins_comparabilite.ensembles_codomaine_reconciliation import _rename_iso_order_binders
    Rf, Rpf = _R_de(R), _R_de(Rp)
