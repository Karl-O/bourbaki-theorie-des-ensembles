...
def raccord_phip(phi="phi", phip="phip", S="S", T="T", u="u"):
    ...
    from bourbaki.cardinaux.iii_2_trichotomie_ordinaux.iso_ordre.ensembles_iso_ordre_reciproque import section_reciproque
    from bourbaki.ensembles.fonctions.ii_3_8_retractions_sections.ensembles_composee_valeurs import composition_valeur_t
...
def coincidence_close(phi="phi", phip="phip", S="S", T="T", u="u", E_set="E"):
    ...
    from bourbaki.cardinaux.iii_2_trichotomie_ordinaux.h_coherences.ensembles_trichotomie_restriction import coincidence_sur_chevauchement
...
def _coincidence_univ_assemble(base, phi2, S1, u):
    ...
    from bourbaki.ordre.iii_1_relations_ordre.isomorphismes_ordre.ensembles_valeur_bridge import valeur_y_egal_j
    from bourbaki.cardinaux.iii_3_equipotence_cardinaux.cantor_bernstein.ensembles_cantor_bernstein_bij import restriction_valeur
...
def coincidence_close_cible(phi="phi", phip="phip", S="S", T="T", u="u"):
    ...
    from bourbaki.cardinaux.iii_2_trichotomie_ordinaux.h_coherences.ensembles_trichotomie_restriction import coincidence_sur_chevauchement_cible
...
def coincidence_close_isos(phi="phi", phip="phip", S="S", T="T", u="u", E_set="E"):
    ...
    from bourbaki.cardinaux.iii_2_trichotomie_ordinaux.coincidence_fusion.ensembles_coincidence_pont import strict_croissante_depuis_iso
    from bourbaki.cardinaux.iii_2_trichotomie_ordinaux.coincidence_fusion.ensembles_coincidence_decharge import auto_de_deux_isos
    ...
    from bourbaki.cardinaux.iii_2_trichotomie_ordinaux.iso_ordre.ensembles_iso_ordre_reciproque import reciproque_isomorphisme_ordre
    from bourbaki.cardinaux.iii_3_equipotence_cardinaux.equipotence.ensembles_bijection import reciproque_fonctionnelle, reciproque_domaine
    from bourbaki.cardinaux.iii_2_trichotomie_ordinaux.coincidence_fusion.ensembles_coincidence_decharge import _Rgraphe
