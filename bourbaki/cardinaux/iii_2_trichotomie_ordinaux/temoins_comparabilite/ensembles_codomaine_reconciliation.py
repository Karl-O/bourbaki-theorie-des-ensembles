...
def iso_restriction_image(phi2="phi2", S1="S1", S2="S2", R="R", Rp="Rp",
    ...
    """
    from bourbaki.cardinaux.iii_2_trichotomie_ordinaux.iso_ordre.ensembles_restriction_iso_pieces import (
...
def iso_T1_vers_image(phi1="phi1", phi2="phi2", S1="S1", T1="T1", S2="S2",
    ...
    """
    from bourbaki.cardinaux.iii_2_trichotomie_ordinaux.iso_ordre.ensembles_iso_ordre_composee import composee_isomorphisme_ordre
...
def _chi_dans_B(chi, B, A, j_hole_unused=None):
    ...
    from bourbaki.cardinaux.iii_2_trichotomie_ordinaux.iso_ordre.ensembles_iso_ordre_composee import valeur_dans_but_surjectif
...
def segment_inclus_par_iso(chi, A, B, Rp, F, a="a", t="t"):
    ...
    from bourbaki.cardinaux.iii_2_trichotomie_ordinaux.lemme4_segments.ensembles_lemme4_sous_domaine import lemme_4_sous_domaine
    from bourbaki.cardinaux.iii_2_trichotomie_ordinaux.lemme4_segments.ensembles_lemme4_croissante import _val
    Rpf = _R_de(Rp)
    ...
    from bourbaki.cardinaux.iii_2_trichotomie_ordinaux.lemme4_segments.ensembles_lemme4_croissante import _f_dans_E
...
def codomaine_egal_image(phi1="phi1", phi2="phi2", S1="S1", T1="T1", S2="S2",
    ...
    from bourbaki.cardinaux.iii_2_trichotomie_ordinaux.lemme4_segments.ensembles_segment_comparabilite_abstrait import (
