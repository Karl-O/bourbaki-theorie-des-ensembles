...
from bourbaki.cardinaux.iii_2_trichotomie_ordinaux.h_coherences.ensembles_trichotomie_coherences import _temoin_commun_coeur
...
def temoin_commun_couvrant_cible(E_set="E", R="R", F_set="F", Rp="Rp",
    ...
    from bourbaki.cardinaux.iii_2_trichotomie_ordinaux.h_coherences.ensembles_trichotomie_coherences import temoin_commun_h
