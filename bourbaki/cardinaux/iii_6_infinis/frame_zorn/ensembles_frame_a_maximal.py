...
from bourbaki.cardinaux.iii_6_infinis.frame_zorn.ensembles_frame_inductif_assemblage import (
    frame_inductif_inconditionnel, m_dans_frame_universel,
)
from bourbaki.cardinaux.iii_6_infinis.frame_zorn.ensembles_frame_ordre_est_ordre import frame_ordre_est_ordre
...
from bourbaki.cardinaux.iii_6_infinis.hessenberg.coeur.ensembles_hessenberg_hard import maximal_pair_existe
...
def _frame_membre_t(vE, vp):
    ...
    from bourbaki.cardinaux.iii_6_infinis.hessenberg.coeur.ensembles_hessenberg_hard import theorie_frame, axiome_frame
