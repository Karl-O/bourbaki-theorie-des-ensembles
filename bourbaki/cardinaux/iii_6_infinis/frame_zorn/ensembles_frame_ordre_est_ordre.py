...
(`bourbaki/cardinaux/ensembles_frame_inductif_assemblage.py`) : `est_ordre(Γ𝔉,𝔉)`.
...
from bourbaki.cardinaux.iii_6_infinis.hessenberg.coeur.ensembles_hessenberg_hard import frame_pair, frame_ordre, frame_membre
from bourbaki.cardinaux.iii_6_infinis.frame_zorn.ensembles_frame_ordre_axiome import frame_ordre_membre_t
