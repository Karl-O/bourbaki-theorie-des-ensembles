...
from bourbaki.cardinaux.iii_6_infinis.hessenberg.assemblage_vrai.ensembles_hessenberg_recollement_final import (
...
from bourbaki.cardinaux.iii_6_infinis.frame_zorn.ensembles_frame_extension_finale import extension_absurde, _u_inclus_reunion
