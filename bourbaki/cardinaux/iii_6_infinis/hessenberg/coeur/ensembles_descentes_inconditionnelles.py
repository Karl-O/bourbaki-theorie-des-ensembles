...
from bourbaki.cardinaux.iii_3_equipotence_cardinaux.ordre_cardinaux.ensembles_cardinal_ordre_props import (
...
from bourbaki.cardinaux.iii_6_infinis.infinis_descentes.ensembles_fini_inf_egal_infini import fini_inf_egal_infini
