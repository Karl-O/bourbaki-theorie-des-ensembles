...
def cadre_plat_cardinal(S="S0", U="Ucadre"):
    ...
    from bourbaki.cardinaux.iii_6_infinis.frame_zorn.ensembles_frame_extension_finale import _card_produit_egal_b
...
def cadre_plat_bijection(S="S0", U="Ucadre"):
    ...
    from bourbaki.cardinaux.iii_6_infinis.frame_zorn.ensembles_frame_extension_finale import cadre_bijection
