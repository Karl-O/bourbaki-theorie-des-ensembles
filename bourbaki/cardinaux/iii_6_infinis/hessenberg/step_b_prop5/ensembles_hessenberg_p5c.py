...
def _u_disjoint_forall_t(E_set, S, tU):
    ...
    from bourbaki.cardinaux.iii_6_infinis.hessenberg.coeur.ensembles_hessenberg_structural_discharge import U_disjoint_S0
    vE, vS = _t(E_set), _t(S)
...
def negation_strict_sous_maximal(E_set="E", phi0="phi0", S="S0", U="Ucadre"):
    ...
    from bourbaki.cardinaux.iii_6_infinis.hessenberg.coeur.ensembles_cadre_plat import cadre_plat, cadre_plat_blocs_disjoints
    from bourbaki.cardinaux.iii_6_infinis.hessenberg.assemblage_vrai.ensembles_hessenberg_recollement_final import _b_le_complement
    from bourbaki.cardinaux.iii_4_ordinal_cardinal.realisation_segment.ensembles_transport_sous_ensemble import (
    ...
    from bourbaki.cardinaux.iii_6_infinis.hessenberg.coeur.ensembles_cadre_plat import commutativite_intersection_t
...
def hessenberg_a_carre_egal_a_REEL(E_set="E"):
    ...
    from bourbaki.cardinaux.iii_6_infinis.hessenberg.coeur.ensembles_hessenberg_maximal_card import maximal_carre_egal
    from bourbaki.cardinaux.iii_6_infinis.hessenberg.coeur.ensembles_hessenberg_structural_discharge import (
        card_inclus_inf_egal,
    )
