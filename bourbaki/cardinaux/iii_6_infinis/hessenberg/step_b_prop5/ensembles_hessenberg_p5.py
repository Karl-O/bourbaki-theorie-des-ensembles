...
def negation_strict_sous_temoins_UF_plat(E_set="E", phi0="phi0", psi="psi", S="S0",
    ...
    """
    from bourbaki.cardinaux.iii_6_infinis.hessenberg.coeur.ensembles_cadre_plat import chaine_falsum_plat, cadre_plat
    from bourbaki.cardinaux.iii_6_infinis.hessenberg.coeur.ensembles_cadre_plat import cadre_plat_bijection
    ...
    from bourbaki.cardinaux.iii_6_infinis.hessenberg.coeur.ensembles_hessenberg_structural_discharge import U_non_vide
