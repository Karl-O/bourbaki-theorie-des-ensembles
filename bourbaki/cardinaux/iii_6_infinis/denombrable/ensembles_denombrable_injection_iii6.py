...
def puissance_succ_eq_incond(a="Apsi", n="Npsi"):
    ...
    from bourbaki.cardinaux.iii_5_entiers.ensembles_puissance_entiers_inconditionnel import B_preuve
    va, vn = _t(a), _t(n)
...
def trois_impair():
    ...
    from bourbaki.cardinaux.iii_5_entiers.ensembles_parite_iii5 import (
        deux_k_plus_un_impair, deux_fois, deux_succ_eq, _deux_fois_zero_eq,
    )
    from bourbaki.cardinaux.iii_3_equipotence_cardinaux.props_restantes.ensembles_divisibilite_propre import est_impair_propre
...
def _trois_puiss_impair_P0():
    ...
    from bourbaki.cardinaux.iii_5_entiers.ensembles_parite_iii5 import un_impair
    from bourbaki.cardinaux.iii_3_equipotence_cardinaux.props_restantes.ensembles_divisibilite_propre import est_impair_propre
...
def _trois_puiss_impair_step(n="ntpis"):
    ...
    from bourbaki.cardinaux.iii_5_entiers.ensembles_parite_iii5 import impair_fois_impair
    from bourbaki.cardinaux.iii_3_equipotence_cardinaux.props_restantes.ensembles_divisibilite_propre import est_impair_propre
    from bourbaki.cardinaux.iii_5_entiers.ensembles_puissance_deux_trois_NN import trois_puissance_dans_NN
...
def deux_puiss_pair_cible(k="kdpp"):
    from bourbaki.cardinaux.iii_3_equipotence_cardinaux.props_restantes.ensembles_divisibilite_propre import est_pair_propre
    vk = _t(k)
...
def deux_puiss_pair(k="kdpp"):
    ...
    ⇒ divise_propre(2, 2^k)."""
    from bourbaki.cardinaux.iii_3_equipotence_cardinaux.props_restantes.ensembles_divisibilite_propre import est_pair_propre
    from bourbaki.cardinaux.iii_5_entiers.ensembles_parite_iii5 import _comm_prod_t
    from bourbaki.cardinaux.iii_5_entiers.ensembles_puissance_deux_trois_NN import deux_puissance_dans_NN
