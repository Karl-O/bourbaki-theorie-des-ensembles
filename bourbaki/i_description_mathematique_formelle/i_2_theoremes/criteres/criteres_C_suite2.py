...
from bourbaki.i_description_mathematique_formelle.assemblage import (negation, disjonction, conjonction, implication, equivalence)
...
from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques import a_implique_a, syllogisme, mono_gauche, mono_droite
from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_prop import (double_negation_intro, double_negation_elim,
...
def c25_second(thm_non_a, b, sig=DEFAUT):
    ...
    from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.i_1_app_lecture import depuis_assemblage, vers_assemblage
