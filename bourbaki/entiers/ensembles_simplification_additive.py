...
from bourbaki.entiers.ensembles_entiers import est_fini, est_entier, successeur, ZERO
...
from bourbaki.entiers.ensembles_recurrence_C61 import principe_recurrence
