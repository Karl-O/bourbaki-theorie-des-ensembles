...
from bourbaki.entiers.ensembles_entiers import successeur, ZERO, est_entier
...
from bourbaki.entiers.ensembles_prop5_prop4_iii5 import prop5_intervalle_zero
