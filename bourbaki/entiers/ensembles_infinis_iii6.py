...
from bourbaki.entiers.ensembles_aleph0 import aleph_0, aleph0_egal_succ, aleph0_infini
...
def dedekind_aleph0():
    ...
    from bourbaki.entiers.ensembles_infinis_props import dedekind_cardinal
    a0 = aleph_0()
...
def aleph0_strict_continu_concret():
    ...
    from bourbaki.entiers.ensembles_chap3_props_restantes import cantor_strict_cardinal
