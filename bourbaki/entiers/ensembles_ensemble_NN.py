...
def _appartenance_NN_cache(x="x", Y="y"):
    ...
    from bourbaki.entiers.ensembles_predecesseur_prop2 import N_existe
...
def NN_clos_successeur(n="n", x="x", Y="y"):
    ...
    from bourbaki.entiers.ensembles_fini_successeur import fini_implique_fini_successeur
    vn = var(n)
