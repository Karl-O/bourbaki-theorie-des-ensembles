...
#  (B) COMPATIBILITÉ D'ORDRE de h⁺ pour relation_adjoint — CŒUR substantiel.
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §2.5 Demo.3 | E III.21 L.36-38 | PDF p.124  (démonstration du Th. 3 : prolongement de u0)
# @livre Ch.III §2.5 Demo.3 | E III.22 L.1-3 | PDF p.125  (démonstration du Th. 3 : u1 = u0 ∪ {(a,b)} est un iso de ]←,a] sur ]←,b])
