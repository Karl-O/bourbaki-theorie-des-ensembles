...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §2.5 Demo.3 | E III.21 L.33-38 | PDF p.124  (démonstration du Th. 3 : cœur de la maximalité — raisonnement par l'absurde)
# @livre Ch.III §2.5 Demo.3 | E III.22 L.1-3 | PDF p.125  (fin de la démonstration du Th. 3 : l'adjonction contredit la maximalité)
