...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.maximalite import ensembles_trichotomie_extension_iso as EXT
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.maximalite import ensembles_trichotomie_maximalite_preuve as MP
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.assemblage import ensembles_trichotomie_temoin_adjonction as ADJ
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.lemme4_segments.ensembles_segments_construction import seg as _seg, membre_segment
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §2.5 Demo.3 | E III.21 L.33-38 | PDF p.124  (démonstration du Th. 3 : maximalité close jusqu'à bo(R,E), bo(Rp,F))
# @livre Ch.III §2.5 Demo.3 | E III.22 L.1-3 | PDF p.125  (fin de la démonstration du Th. 3)
def maximalite_donne_trichotomie_close(E_set="E", R="R", F_set="F", Rp="Rp"):
    ...
    from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import dne, mono_gauche
