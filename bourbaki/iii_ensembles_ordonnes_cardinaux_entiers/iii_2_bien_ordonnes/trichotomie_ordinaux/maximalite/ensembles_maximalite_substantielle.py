...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.h_coherences import ensembles_trichotomie_h_iso as HI
...
# @livre Ch.III §2.5 Demo.3 | E III.21 L.33-38 | PDF p.124  (démonstration du Th. 3 : « soit S0=E, soit u0(S0)=F » — maximalité substantielle de h)
