...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §2.5 Demo.3 | E III.21 L.23-33 | PDF p.124  (démonstration du Th. 3 : forme ensembliste de h — est_un_graphe(h) prouvé)
def h_est_graphe(E_set="E", R="R", F_set="F", Rp="Rp", z="z", a="a", b="b"):
    ...
    from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import projection_gauche
...
def _alpha_existe2(src, a, b, x, y, vz):
    ...
    from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import subst_f as _subst
    va = var(a)
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §2.5 Th.3 | E III.21 L.18-22 | PDF p.124  (conclusion du Théorème 3 — réduction v3)
def trichotomie_ordinaux_canon_close_v3(E_set="E", R="R", F_set="F", Rp="Rp"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.h_coherences import ensembles_trichotomie_hgraphe_pr2seg as HG
