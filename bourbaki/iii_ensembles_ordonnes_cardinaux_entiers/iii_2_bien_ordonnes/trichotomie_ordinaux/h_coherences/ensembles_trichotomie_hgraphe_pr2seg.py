...
from bourbaki.ii_theorie_des_ensembles.ii_3_correspondances.ii_3_1_graphes_correspondances.ensembles_correspondances import _inst_image, _inst_img
...
# @livre Ch.III §2.5 Demo.3 | E III.21 L.26-29 | PDF p.124  (démonstration du Th. 3 : « v(S) … est un segment de F » — pr2(h) segment de F)
...
# @livre Ch.III §2.5 Th.3 | E III.21 L.18-22 | PDF p.124  (conclusion du Théorème 3 — réduction v2)
