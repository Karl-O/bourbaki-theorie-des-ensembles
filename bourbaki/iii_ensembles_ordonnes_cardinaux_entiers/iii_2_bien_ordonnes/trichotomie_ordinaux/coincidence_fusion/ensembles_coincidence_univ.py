...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import Terme, var, appartient, inclus
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §2.5 Cor.1 | E III.22 L.15-16 | PDF p.125  (unicité de l'iso entre bons ordres, restreinte au chevauchement S1)
# @livre Ch.III §2.5 Demo.- | E III.22 L.17-17 | PDF p.125  (démonstration du Cor. 1 — ici via l'automorphisme c = φ2⁻¹∘φ1 = identité)
