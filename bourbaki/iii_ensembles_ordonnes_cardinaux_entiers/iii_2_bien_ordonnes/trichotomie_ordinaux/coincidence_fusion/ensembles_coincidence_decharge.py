...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.iso_ordre.ensembles_iso_ordre_composee import (
    composee_isomorphisme_ordre,
)
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.iso_ordre.ensembles_iso_ordre_reciproque import (
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §2.5 Cor.1 | E III.22 L.15-16 | PDF p.125  (unicité de l'iso : coïncidence de deux isos via l'automorphisme identité — maillon de décharge)
