...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.lemme4_segments import ensembles_segment_comparabilite_abstrait as CMP
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.coincidence_fusion.ensembles_fusion_app import coincidence_point_app
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.temoins_comparabilite.ensembles_codomaine_reconciliation import (
...
def _coinc_point_app(E_set, R, F_set, Rp,
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.assemblage.ensembles_trichotomie_residuals import residu_univ_app_renforce
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §2.5 Demo.3 | E III.21 L.26-33 | PDF p.124  (démonstration du Th. 3 : fusion dérivée de la coïncidence prouvée — dernier postulat géométrique retiré)
