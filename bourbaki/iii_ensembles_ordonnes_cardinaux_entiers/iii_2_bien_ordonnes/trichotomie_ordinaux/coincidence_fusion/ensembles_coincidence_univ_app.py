...
def reciproque_inclusion_monotone(g="G", h="H"):
    ...
    from bourbaki.ii_theorie_des_ensembles.ii_3_correspondances.ii_3_2_reciproque.ensembles_reciproque import _inst_recip_z
    vG, vH = _t(g), _t(h)
...
def reciproque_inclus_produit_miroir(g, A, B):
    ...
    from bourbaki.ii_theorie_des_ensembles.ii_3_correspondances.ii_3_2_reciproque.ensembles_reciproque import reciproque_produit
...
def coincidence_univ_app_point(phi1="phi1", phi2="phi2", S1="S1", T1="T1",
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.coincidence_fusion.ensembles_coincidence_geometrie import (
        coincidence_univ_close_isos,
    )
...
# @livre Ch.III §2.5 Cor.1 | E III.22 L.15-16 | PDF p.125  (unicité de l'iso : réduction à une prémisse propre « applications »)
