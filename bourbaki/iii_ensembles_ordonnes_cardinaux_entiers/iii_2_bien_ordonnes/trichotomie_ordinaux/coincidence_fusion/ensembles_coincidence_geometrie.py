...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import Terme, var, egal, appartient, inclus, pourtout, impl
...
from bourbaki.ii_theorie_des_ensembles.ii_3_correspondances.ii_3_7_composee_fonctions.ensembles_fonctions_composee import composition_valeur
...
def retraction_phi(phi="phi", S="S", T="T", x="x"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_1_relations_ordre.isomorphismes_ordre.ensembles_valeur_bridge import valeur_y_egal_j
...
def raccord_phip(phi="phi", phip="phip", S="S", T="T", u="u"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.iso_ordre.ensembles_iso_ordre_reciproque import section_reciproque
    from bourbaki.ii_theorie_des_ensembles.ii_3_correspondances.ii_3_8_retractions_sections.ensembles_composee_valeurs import composition_valeur_t
...
def coincidence_close(phi="phi", phip="phip", S="S", T="T", u="u", E_set="E"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.h_coherences.ensembles_trichotomie_restriction import coincidence_sur_chevauchement
...
# @livre Ch.III §2.5 Cor.1 | E III.22 L.15-16 | PDF p.125  (unicité de l'iso : géométrie de c et k dérivée des données d'iso)
...
def _coincidence_univ_assemble(base, phi2, S1, u):
    ...
    from bourbaki.i_description_mathematique_formelle.i_5_theories_egalitaires.i_5_2_tactiques_abrege_egalite import composer_egalites
    from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import instancie as _i
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_1_relations_ordre.isomorphismes_ordre.ensembles_valeur_bridge import valeur_y_egal_j
...
def coincidence_close_cible(phi="phi", phip="phip", S="S", T="T", u="u"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.h_coherences.ensembles_trichotomie_restriction import coincidence_sur_chevauchement_cible
...
def coincidence_close_isos(phi="phi", phip="phip", S="S", T="T", u="u", E_set="E"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.coincidence_fusion.ensembles_coincidence_pont import strict_croissante_depuis_iso
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.coincidence_fusion.ensembles_coincidence_decharge import auto_de_deux_isos
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.iso_ordre.ensembles_iso_ordre_reciproque import reciproque_isomorphisme_ordre
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.equipotence.ensembles_bijection import reciproque_fonctionnelle, reciproque_domaine
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.coincidence_fusion.ensembles_coincidence_decharge import _Rgraphe
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_1_relations_ordre.ordre_treillis.ensembles_ordre_vocab import est_isomorphisme_ordre as _Viso
