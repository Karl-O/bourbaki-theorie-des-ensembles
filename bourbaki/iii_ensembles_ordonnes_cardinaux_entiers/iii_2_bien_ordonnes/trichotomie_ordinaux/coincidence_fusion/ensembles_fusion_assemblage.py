...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §2.5 Demo.3 | E III.21 L.26-33 | PDF p.124  (démonstration du Th. 3 : recollement — la borne supérieure des isos est un iso ; fusion_hyp modulo coïncidence)
