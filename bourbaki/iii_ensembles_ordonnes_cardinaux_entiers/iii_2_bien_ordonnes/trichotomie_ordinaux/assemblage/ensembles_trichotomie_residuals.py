...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.cantor_bernstein.ensembles_cantor_bernstein import inclusion_transitive_terme
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.coincidence_fusion.ensembles_coincidence_univ_app import _premisse_liste
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.coincidence_fusion.ensembles_fusion_depuis_coincidence_app import _DISCHARGEABLE
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.assemblage import ensembles_trichotomie_pont_val as PV
...
def restriction_inclus_produit_Tp(phip="phip", phig="phig", Sp="Sp", Tp="Tp",
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.temoins_comparabilite.ensembles_codomaine_reconciliation import codomaine_egal_image
...
def _residu_consequent_prouve(E_set, R, F_set, Rp, Sp, Tp, phip, Sg, Tg, phig):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.temoins_comparabilite.ensembles_codomaine_reconciliation import _rename_iso_order_binders
    Rf, Rpf = _R_de(R), _R_de(Rp)
...
# @livre Ch.III §2.5 Demo.3 | E III.21 L.23-38 | PDF p.124  (démonstration du Th. 3 : décharge des résidus de bonne-formation géométrique)
...
def trichotomie_ordinaux_canon_close(E_set="E", R="R", F_set="F", Rp="Rp"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.assemblage import ensembles_trichotomie_assemble as A
