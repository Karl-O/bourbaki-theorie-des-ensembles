...
# @livre Ch.III §2.5 Demo.3 | E III.21 L.33-38 | PDF p.124  (démonstration du Th. 3 : endgame — S0=E ou u0(S0)=F donne l'un des deux isomorphismes)
...
def maillon_final_h(E_set="E", R="R", F_set="F", Rp="Rp"):
    ...
    import bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.iso_ordre.ensembles_iso_ordre_reciproque as RE
    Rf, Rpf = _R_de(R), _R_de(Rp)
    vE, vF = _t(E_set), _t(F_set)
