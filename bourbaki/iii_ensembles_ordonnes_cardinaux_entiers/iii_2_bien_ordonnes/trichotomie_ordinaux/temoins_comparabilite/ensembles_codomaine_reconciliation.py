...
def iso_restriction_image(phi2="phi2", S1="S1", S2="S2", R="R", Rp="Rp",
    ...
    """
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.iso_ordre.ensembles_restriction_iso_pieces import (
...
def iso_T1_vers_image(phi1="phi1", phi2="phi2", S1="S1", T1="T1", S2="S2",
    ...
    """
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.iso_ordre.ensembles_iso_ordre_composee import composee_isomorphisme_ordre
...
def _chi_dans_B(chi, B, A, j_hole_unused=None):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.iso_ordre.ensembles_iso_ordre_composee import valeur_dans_but_surjectif
...
def _strict_croissante_depuis_iso_into(chi, B, A, Rp):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.coincidence_fusion.ensembles_coincidence_pont import (
        compat_y_vers_jv, inj_y_vers_jv,
    )
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.iso_ordre.ensembles_iso_unicite_finale import (
        _compat_yv, _inj_hyp, iso_donne_strict_croissant,
    )
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_1_relations_ordre.ordre_treillis.ensembles_ordre_vocab import compatible_ordre
    Rpf = _R_de(Rp)
    vchi, vB, vA = _t(chi), _t(B), _t(A)
...
def segment_inclus_par_iso(chi, A, B, Rp, F, a="a", t="t"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.lemme4_segments.ensembles_lemme4_sous_domaine import lemme_4_sous_domaine
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.lemme4_segments.ensembles_lemme4_croissante import _val
    Rpf = _R_de(Rp)
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.lemme4_segments.ensembles_lemme4_croissante import _f_dans_E
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §2.5 Cor.1 | E III.22 L.15-16 | PDF p.125  (unicité de l'iso : raccord des codomaines T1 = image(φ2, S1))
def codomaine_egal_image(phi1="phi1", phi2="phi2", S1="S1", T1="T1", S2="S2",
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.lemme4_segments.ensembles_segment_comparabilite_abstrait import (
