...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §2.5 Cor.1 | E III.22 L.15-16 | PDF p.125  (cœur algébrique : un automorphisme d'ordre d'un bon ordre est l'identité)
# @livre Ch.III §2.5 Demo.- | E III.22 L.17-17 | PDF p.125  (démonstration du Cor. 1 via le Lemme 4 : x ≤ h(x), x ≤ k(x), antisymétrie)
