...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.trichotomie_ordinaux.iso_ordre.ensembles_iso_unicite import (
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §2.5 Th.3 | E III.21 L.18-22 | PDF p.124  (le « un et un seul » du Théorème 3 : f = g)
# @livre Ch.III §2.5 Cor.1 | E III.22 L.15-16 | PDF p.125  (unicité via Cor. 1 : f∘g⁻¹ = identité)
