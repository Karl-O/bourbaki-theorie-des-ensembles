...
initiaux de (a,R), indexés par les ÉLÉMENTS t∈a :
    ...
    seg(a,R,t) := segment_extremite(R, a, t)  [R = le GRAPHE, porte par le terme] = { u∈a | R{u,t} et u≠t }     (E.III.2.1)
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.ordinal_cardinal.ordinal_cardinal_correspondance.ensembles_ordinal_cardinal_bon_ordre import plus_petit_de_bon_ordre
...
def seg(R, a, t):
    ...
    return E.segment_extremite(_t(R), _t(a), _t(t))
...
def membre_segment(R="R", a="a", t="t", u="u"):
    ...
    ax = instancie(N.axiome(th, E.axiome_segment_extremite()), _t(R))  # (∀E∀x∀y)( y∈S_x ⇔ ((y∈E et R{y,x}) et y≠x) )
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §2.1 Prop.2 | E III.16 L.21-30 | PDF p.119  (monotonie des segments initiaux réels — brique de l'arc C61/N)
def seg_strict_monotone(R="R", a="a", t="t", s="s", u="u"):
    ...
    from bourbaki.i_description_mathematique_formelle.i_5_theories_egalitaires.i_5_2_tactiques_abrege_egalite import symetrie as _sym, transitivite as _trans_eg
