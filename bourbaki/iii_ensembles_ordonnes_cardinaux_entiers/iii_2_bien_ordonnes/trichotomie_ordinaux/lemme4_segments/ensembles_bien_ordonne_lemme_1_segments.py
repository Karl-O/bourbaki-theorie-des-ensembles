...
Le VRAI segment initial strict d'extrémité t est (E.III.2.1)
    ...
    seg(a,R,t) := segment_extremite(R, a, t)  [R = le GRAPHE, porte par le terme] = { u∈a | R{u,t} et u≠t },
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §2.1 Prop.2 | E III.16 L.21-30 | PDF p.119  (ossature de l'iso t ↦ S_t d'un bon ordre sur ses segments propres)
