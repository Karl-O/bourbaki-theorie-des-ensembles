...
Le VRAI segment initial strict d'extrémité t est (E.III.2.1)
    ...
    seg(E,R,t) := segment_extremite(G, E, t) = { u∈E | R{u,t} et u≠t },
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.bon_ordre.bon_ordre_segments.ensembles_segment_strict_propre import (
    seg_strict_propre,
)
