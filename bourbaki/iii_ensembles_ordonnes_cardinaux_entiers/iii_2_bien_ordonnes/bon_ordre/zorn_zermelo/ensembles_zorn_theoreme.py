...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.bon_ordre.zorn_zermelo.ensembles_bourbaki_witt_chaine import (
...
def _non_maximal_donne_strict(G, E_set, m, hmE, hsans, x="x", t="t"):
    ...
    from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import dne, demorgan_et
...
def _reformule_strict(G, E_set, m, ex_conj, x, t):
    ...
    from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import equivalence_symetrie
...
# @livre Ch.III §2.4 Demo.2 | E III.20 L.37-41 | PDF p.123  (démonstration Th. 2 / Prop. 4 — livre : lemme 3 + majorant strict + τ ; ici via Bourbaki–Witt)
# @livre Ch.III §2.4 Demo.2 | E III.21 L.1-10 | PDF p.124  (fin de la démonstration : M bien ordonnée sans majorant strict ⇒ m élément maximal)
