...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §2.2 Demo.60 | E III.18 L.34-39 | PDF p.121  (démonstration de C60, existence : réunion de la famille des essais)
# @livre Ch.III §2.2 Demo.60 | E III.19 L.1-5 | PDF p.122  (fin de la démonstration de C60 : sur S = S_x ∪ {x} on définit f_S prolongeant f_S_x)
