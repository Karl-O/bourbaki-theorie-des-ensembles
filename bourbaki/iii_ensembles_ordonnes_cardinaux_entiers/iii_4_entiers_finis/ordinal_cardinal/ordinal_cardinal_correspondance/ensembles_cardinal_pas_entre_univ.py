...
RESSOURCE DE DÉPART — DÉJÀ PROUVÉE, sous une SEULE garde structurelle :
    ...
    cardinal_pas_entre_inconditionnel(b, c)
        (bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.ordinal_cardinal.equipotence_retrait.ensembles_equipotence_retrait, THÉORÈME CLOS, 0 hyp)
