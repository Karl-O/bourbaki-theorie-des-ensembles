...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (Terme, var, egal, et, non, impl, existe,
                                       inclus, appartient)
...
def _dans_singleton_star_ssi(z):
    ...
    from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import ou
...
def diff_marqueur_egal_copie(c="c"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_4_prop8_successeur.ensembles_prop8_plus_point import marqueur_hors_copie_gauche
