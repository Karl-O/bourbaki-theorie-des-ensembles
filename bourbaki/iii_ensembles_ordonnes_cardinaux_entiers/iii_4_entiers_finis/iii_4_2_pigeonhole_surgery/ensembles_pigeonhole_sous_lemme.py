...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_1_definitions_premiers_entiers.ensembles_entiers import est_fini_ensemble, est_entier, ZERO
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.cantor_bernstein.ensembles_cantor_bernstein_fin import (
    partie_reunion_complement, partie_disjoint_complement,
)
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_recurrence_c61_existence_n.ensembles_predecesseur_prop2 import eq_reunion_disjointe_somme
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_3_somme.ensembles_arith_somme import _prop1_direct_t
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_5_calcul_entiers.iii_5_1_somme_produit_entiers.ensembles_combinatoire_iii5 import somme_zero_neutre_droite, _sdc
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_5_calcul_entiers.iii_5_1_somme_produit_entiers.ensembles_simplification_additive import simplification_additive_finie
...
from bourbaki.ii_theorie_des_ensembles.ii_1_relations_collectivisantes.ensembles_vide_identites import reunion_vide_neutre
...
def _diff_inclus(tE, tX, w="z"):
    ...
    from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import appartient, impl, non, inclus
    from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import projection_gauche, syllogisme
    ...
    if w in libres_t(EmX) | libres_t(tE):
        from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import _fraiche
        w = _fraiche(libres_t(EmX) | libres_t(tE))
    vw = var(w)
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.cantor_bernstein.ensembles_cantor_bernstein_fin import _inst_diff
...
def partie_egal_cardinal_egal_enonce(X="Xpe", Eens="Epe"):
    ...
    from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import impl, inclus
    vX, vE = _t(X), _t(Eens)
...
def partie_egal_cardinal_egal(X="Xpe", Eens="Epe"):
    ...
    from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import appartient   # noqa
...
def cor2_partie_propre_inf_strict_enonce(X="Xpe", Eens="Epe"):
    ...
    from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import impl, inclus, non
    vX, vE = _t(X), _t(Eens)
