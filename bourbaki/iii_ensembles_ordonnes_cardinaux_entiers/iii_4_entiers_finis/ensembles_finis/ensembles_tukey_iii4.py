...
DÉFINITION 2 (E.III.34, §III.4.5, lue VERBATIM dans le PDF source) :
    ...
    X appartient à 𝔖 » ).
(prédicat `de_caractere_fini` de bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_1_definitions_premiers_entiers.ensembles_entiers, LU verbatim.)
...
from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege import a_implique_a, inclusion_reflexive
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_1_definitions_premiers_entiers.ensembles_entiers import de_caractere_fini, est_fini_ensemble
