...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_5_calcul_entiers.iii_5_1_somme_produit_entiers.ensembles_recurrence_finie import (
...
def _preuve_pas_total(G, E_set, htot, P, X="Xrec", x="xrec", z="zpgT", m="m_pgf"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_5_calcul_entiers.iii_5_1_somme_produit_entiers.ensembles_recurrence_finie import _pas_ensemble
    vE = _t(E_set)
...
# @livre Ch.R §6 Prop.- | E.R.27 item 5 (partie finie non vide d'un totalement ordonné : plus grand élément) | PDF p.330
def prop3_total(G="Gpgt", E_set="Epgt", X="Xpgt", m="m_pgf"):
    ...
    from bourbaki.ii_theorie_des_ensembles.ii_1_relations_collectivisantes import ensembles_abrege as _E
...
def _preuve_pas_maximal(G, E_set, hord, P, X="Xrec", x="xrec",
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_5_calcul_entiers.iii_5_1_somme_produit_entiers.ensembles_recurrence_finie import _pas_ensemble
    from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import tiers_exclu, dne, dni
    vE = _t(E_set)
    vX, vx = var(X), var(x)
    va, vm = var(a), var(m)
    vt = var(_ZEM)
