...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_5_calcul_entiers.iii_5_1_somme_produit_entiers.ensembles_recurrence_finie import recurrence_finie
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.bon_ordre.zorn_zermelo.ensembles_zorn_theoreme import Union, _inst_Union
...
def _tukey_via_per_chaine(S, m, T, x, y, z, Y, M, hyp, H, Hcf, Hnv, Hcnv):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.bon_ordre.zorn_zermelo.ensembles_zorn_theoreme import Union
    U = Union(G, vS, vT)
