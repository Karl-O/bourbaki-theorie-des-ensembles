...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (Terme, var, app, egal, et, non, impl, existe, pourtout, equiv,
                     inclus, appartient)
from bourbaki.ii_theorie_des_ensembles.ii_1_relations_collectivisantes import ensembles_abrege as E
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.definitions_cardinaux.ensembles_cardinaux import (cardinal, est_cardinal, CARD_VIDE,
...
def intervalle_entiers(a, b):
    ...
    Le corps caractérisant et l'axiome `axiome_intervalle_entiers` (nom RÉEL, vérifié
    par grep le 27 juil. 2026 ; « AXIOME_INTERV_ENT » n'a jamais existé) sont dans
...
def divise(b, a, q="q"):
    ...
    ⚠ RÉSERVE PÉRIMÉE, corrigée le 5 août 2026 : le produit cardinal BINAIRE **est** désormais disponible (`produit_cardinal_binaire`, iii_3_3_produit/ensembles_arith_cardinale), et la version FIDÈLE de la divisibilité existe : `divise_propre` (iii_3_equipotence_cardinaux/props_restantes/ensembles_divisibilite_propre), bâtie sur Card(b×q).  Ce qui suit garde la forme OPAQUE app("prod_ent") non par nécessité mais parce que des THÉORÈMES en dépendent (ensembles_division_multiples : transitivité et compatibilités de `divise`) : les migrer est un refactor de PREUVES, pas une réécriture de définition.  Chantier borné et identifié — cf. REPORTES."""
