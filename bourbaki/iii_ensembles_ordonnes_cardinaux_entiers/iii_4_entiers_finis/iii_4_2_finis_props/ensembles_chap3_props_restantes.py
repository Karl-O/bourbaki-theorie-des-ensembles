...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_4_prop8_successeur.ensembles_prop8_successeur import prop1_reciproque_t
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_5_calcul_entiers.iii_5_1_somme_produit_entiers.ensembles_calcul_entiers_props import le_ens_implique_le_card
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.entiers_infinis.iii_6_3_infinis_denombrables.ensembles_infinis import NN, aleph0, puissance_continu
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §3.1 Def.2 | E III.23 L.27-28 | PDF p.126
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §3.6 Th.2 | E III.30 L.20-20 | PDF p.133
# @livre Ch.III §3.6 Demo.2 | E III.30 L.21-26 | PDF p.133
...
def _card_parties_egale_deux_exp_t(vX):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_5_exposant.prop12_powerset.prop12_card import card_parties_egale_deux_exp
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.4 Rem.- | E III.50 L.26-27 | PDF p.153
