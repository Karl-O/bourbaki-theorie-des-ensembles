...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.ordinal_cardinal.ordinal_cardinal_correspondance.ensembles_cardinal_pas_entre_univ import cardinal_pas_entre_univ
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.entiers_infinis.iii_6_3_infinis_denombrables.ensembles_infinis import est_infini_ensemble, A4, theorie_infini
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §4.3 Demo.C61 | E III.32 L.23-31 | PDF p.135
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.1 Rem.- | E III.45 L.5-14 | PDF p.148
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.1 Th.1 | E III.45 L.20-20 | PDF p.148
# @livre Ch.III §6.1 Rem.- | E III.45 L.5-14 | PDF p.148
