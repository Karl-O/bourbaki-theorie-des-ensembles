...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.ordinal_cardinal.realisation_segment.ensembles_gate_onto_top import cardinaux_bien_ordonnes_close
...
def _A_inclus_interv_raw(P, n0, mbind="mApr"):
    ...
    if interv_at0 is None:
        # subst court-circuit (fix verrou-τ 2026-07-24) : plus de renommage gratuit,
        # raw_at0 EST déjà la forme RAW 'z' propre — le pont s7 n'a plus d'objet.
        assert raw_at0.conclusion == inclus(A, interv), "forme RAW inattendue (ni '@0' ni propre)"
        assert raw_at0.est_clos, "A_sub_raw non clos"
        return raw_at0
...
def N_collectivise_report1_discharge(a="a", x="x", c="c", b="b"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_recurrence_c61_existence_n.ensembles_recurrence_C61 import N_collectivise_final
