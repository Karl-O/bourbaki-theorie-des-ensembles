...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §7.3 Def.- | E III.56 L.21-37 | PDF p.159
#   (mise en place de la double limite projective, sous l'intitulé « 3. Double limite
#    projective » : système (E^λ_α, f^λμ_αβ) sur le produit I×L, formules (11) cocycle
#    double, (12) g^λ_αβ, (13) h^λν = h^λμ∘h^μν, F = lim← F^λ ⊂ ∏_λ F^λ — la
#    factorisation (11) est portée ci-dessous en HYPOTHÈSE H11)
