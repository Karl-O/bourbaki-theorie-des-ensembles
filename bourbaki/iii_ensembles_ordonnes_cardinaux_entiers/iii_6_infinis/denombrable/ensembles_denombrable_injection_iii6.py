...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import Terme, var, egal, et, ou, non, impl, existe, pourtout
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.definitions_cardinaux.ensembles_cardinaux import est_cardinal, cardinal, inf_strict_card
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_1_definitions_premiers_entiers.ensembles_entiers import est_fini, est_entier, successeur, ZERO, DEUX, TROIS
...
# @livre Ch.III §6.3 Demo.Lem2 | E III.48 L.4-16 | PDF p.151  (vers l'injection ℕ×ℕ↪ℕ : route (m,n)↦2^m·3^n, alternative au développement dyadique du livre)
...
def trois_impair():
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.props_restantes.ensembles_divisibilite_propre import est_impair_propre
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_1_definitions_premiers_entiers.ensembles_fini_zero import zero_est_un_cardinal, fini_zero
...
def _trois_puiss_impair_P0():
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_5_calcul_entiers.entiers_cardinaux.ensembles_parite_iii5 import un_impair
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.props_restantes.ensembles_divisibilite_propre import est_impair_propre
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_1_definitions_premiers_entiers.ensembles_fini_un import un_egale_card_singleton
...
def _trois_puiss_impair_step(n="ntpis"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_5_calcul_entiers.entiers_cardinaux.ensembles_parite_iii5 import impair_fois_impair
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.props_restantes.ensembles_divisibilite_propre import est_impair_propre
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_5_calcul_entiers.entiers_cardinaux.ensembles_puissance_deux_trois_NN import trois_puissance_dans_NN
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_1_definitions_premiers_entiers.ensembles_fini_trois_quatre import trois_est_un_cardinal
...
# @livre Ch.III §6.3 Demo.Lem2 | E III.48 L.4-16 | PDF p.151  (3^n impair — brique d'injectivité du couplage)
...
def deux_puiss_pair_cible(k="kdpp"):
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.props_restantes.ensembles_divisibilite_propre import est_pair_propre
    vk = _t(k)
    return impl(et(est_fini(vk), non(egal(vk, ZERO))),
                est_pair_propre(exposant_cardinal_binaire(DEUX, vk)))


# @livre Ch.III §6.3 Demo.Lem2 | E III.48 L.4-16 | PDF p.151  (2^k pair pour k≥1 — brique d'injectivité du couplage)
def deux_puiss_pair(k="kdpp"):
    ...
    ⇒ divise_propre(2, 2^k)."""
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.props_restantes.ensembles_divisibilite_propre import est_pair_propre
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_5_calcul_entiers.entiers_cardinaux.ensembles_parite_iii5 import _comm_prod_t
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_5_calcul_entiers.entiers_cardinaux.ensembles_puissance_deux_trois_NN import deux_puissance_dans_NN
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_1_definitions_premiers_entiers.ensembles_fini_deux import deux_est_un_cardinal
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_recurrence_c61_existence_n.ensembles_principe_recurrence_preuve import predecesseur_fini
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_recurrence_c61_existence_n.ensembles_predecesseur_prop2 import (
        predecesseur_fini_universel_preuve,
    )
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_1_definitions_premiers_entiers.ensembles_fini_successeur import fini_successeur_implique_fini
    vk = _t(k)
...
# @livre Ch.III §6.3 Demo.Lem2 | E III.48 L.4-16 | PDF p.151  (simplification multiplicative — brique d'injectivité du couplage)
def simplification_multiplicative(a="asm", b="bsm", c="csm", d="dsm"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_5_calcul_entiers.iii_5_2_inegalites_ordre_soustraction.ensembles_prop3_strict_mono_iii5 import produit_strict_monotone
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.definitions_cardinaux.ensembles_cardinaux import inf_strict_card
    from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import cas
    va, vb, vc = _t(a), _t(b), _t(c)
    ac = produit_cardinal_binaire(va, vc)
    bc = produit_cardinal_binaire(vb, vc)
