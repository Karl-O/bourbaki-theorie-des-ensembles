...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (Terme, var, egal, et, impl, existe, appartient)
...
# @livre Ch.III §6.3 Demo.2 | E III.48 L.17-19 | PDF p.151  (direction facile a ≤ a·a, injection diagonale — implicite chez Bourbaki, close ici)
...
# @livre Ch.III §6.3 Demo.2 | E III.48 L.17-19 | PDF p.151  (a ≤ a·a, moitié facile du théorème, via la diagonale u↦(u,u))
...
def carre_inf_egal_si_hard(a="A"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.props_restantes.ensembles_cardinaux_props_restantes import _cardinal_idempotent_t
...
# @livre Ch.III §6.3 Th.2 | E III.47 L.30-32 | PDF p.150  (« Pour tout cardinal infini 𝔞, on a 𝔞² = 𝔞 » — l'énoncé-cible)
...
# @livre Ch.III §6.3 Demo.2 | E III.48 L.17-19 | PDF p.151  (pont Cantor–Bernstein : (a·a ≤ a) ⇒ a·a = a)
