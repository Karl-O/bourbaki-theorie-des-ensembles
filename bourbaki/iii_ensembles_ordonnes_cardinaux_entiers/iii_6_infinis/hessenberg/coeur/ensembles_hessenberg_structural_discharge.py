...
# @livre Ch.III §6.3 Demo.2 | E III.48 L.19-21 | PDF p.151  (extraction dom/image de la bijection ψ d'un membre de 𝔐)
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.3 Demo.2 | E III.48 L.29-30 | PDF p.151  (Y ≠ ∅ : le témoin de la partie Y ⊂ E∖F équipotente à F)
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.3 Demo.2 | E III.48 L.29-30 | PDF p.151  (Y ⊂ E∖F ⇒ Y∩F=∅)
...
def _eq_implique_le_t(tX, tY):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.ordinal_cardinal.realisation_segment.ensembles_subset_realise_close import (
...
# @livre Ch.III §6.3 Demo.2 | E III.48 L.28-29 | PDF p.151  (F ⊂ E ⇒ Card F ≤ Card E, pont ensembliste)
