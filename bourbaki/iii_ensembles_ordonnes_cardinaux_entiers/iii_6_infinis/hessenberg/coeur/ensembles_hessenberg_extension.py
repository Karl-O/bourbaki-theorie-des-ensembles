...
# ════════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.3 Demo.2 | E III.48 L.28-29 | PDF p.151  (« De l'hypothèse 𝔟 < 𝔞, il résulte que Card(E∖F) > 𝔟 »)
...
# @livre Ch.III §6.3 Demo.2 | E III.48 L.29-30 | PDF p.151  (« Il existe donc une partie Y ⊂ E∖F équipotente à F »)
