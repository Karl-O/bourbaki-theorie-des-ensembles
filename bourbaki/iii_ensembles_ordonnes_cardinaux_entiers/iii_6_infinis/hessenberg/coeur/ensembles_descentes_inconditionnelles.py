...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_1_definitions_premiers_entiers.ensembles_entiers import UN, DEUX, TROIS, est_fini
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_5_calcul_entiers.iii_5_1_somme_produit_entiers.ensembles_combinatoire_iii5 import _sdc
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.infinis_descentes.ensembles_fini_inf_egal_infini import fini_inf_egal_infini

from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.hessenberg.coeur.ensembles_hessenberg_2b3b import deux_b_egal_b, trois_b_egal_b
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.3 Demo.2 | E III.48 L.26-28 | PDF p.151  (descente 2𝔟=𝔟 déchargée via « n ≤ 𝔟 pour 𝔟 infini », E III.45 L.5-9)
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.3 Demo.2 | E III.48 L.26-28 | PDF p.151  (descente 3𝔟=𝔟 déchargée, même route)
