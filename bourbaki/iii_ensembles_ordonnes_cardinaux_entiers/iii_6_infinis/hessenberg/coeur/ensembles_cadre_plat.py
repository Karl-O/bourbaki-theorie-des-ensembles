...
def _efq(notP_thm, q):
    ...
    from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import dni, dne, contraposition
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.3 Demo.2 | E III.48 L.31-34 | PDF p.151  (« Z×Z = (F×F)∪(F×Y)∪(Y×F)∪(Y×Y) … deux à deux disjoints »)
...
# @livre Ch.III §6.3 Demo.2 | E III.48 L.34-37 | PDF p.151  (« Card((F×Y)∪(Y×F)∪(Y×Y)) = 3𝔟 = 𝔟 »)
def cadre_plat_cardinal(S="S0", U="Ucadre"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.frame_zorn.ensembles_frame_extension_finale import _card_produit_egal_b
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.ordinal_cardinal.equipotence_retrait.ensembles_equipotence_retrait import equipotence_reflexive_pour
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.3 Demo.2 | E III.49 L.1-2 | PDF p.152  (bijection f₁ de Y sur le cadre plat)
def cadre_plat_bijection(S="S0", U="Ucadre"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.frame_zorn.ensembles_frame_extension_finale import cadre_bijection
...
def phi_etendue_bijection_plat(phi0="phi0", psi="psi", S="S0", U="Ucadre"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.recollement.ensembles_dom_image_reunion import (
...
def extension_dans_frame_chainee_plat(E_set="E", phi0="phi0", psi="psi", S="S0", U="Ucadre"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.frame_zorn.ensembles_frame_extension_finale import extension_dans_frame
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.definitions_cardinaux.ensembles_cardinaux import est_bijection_de
...
def extension_ordre_chainee_plat(E_set="E", phi0="phi0", psi="psi", S="S0", U="Ucadre"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.frame_zorn.ensembles_frame_extension_finale import extension_ordre
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.hessenberg.assemblage_vrai.ensembles_hessenberg_chaine_vraie import (
...
def extension_force_egalite_chainee_plat(E_set="E", phi0="phi0", psi="psi", S="S0", U="Ucadre"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.frame_zorn.ensembles_frame_extension_finale import extension_force_egalite
...
def extension_absurde_chainee_plat(E_set="E", phi0="phi0", psi="psi", S="S0",
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.frame_zorn.ensembles_frame_extension_finale import extension_absurde
    vS, vU = _t(S), _t(U)
    Z = E.reunion(vS, vU)
    h_Zlock = egal(Z, vS)
...
# @livre Ch.III §6.3 Demo.2 | E III.49 L.3-4 | PDF p.152  (g prolonge f, « contraire à la définition de f » : falsum de la maximalité)
def chaine_falsum_plat(E_set="E", phi0="phi0", S="S0", U="Ucadre", psi="psi", u="uwit"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.hessenberg.coeur.ensembles_hessenberg_structural_discharge import U_disjoint_S0
    vU, vu = _t(U), _t(u)
