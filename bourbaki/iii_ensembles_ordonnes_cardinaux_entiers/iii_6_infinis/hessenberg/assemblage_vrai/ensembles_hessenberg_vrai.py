...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.hessenberg.assemblage_vrai.ensembles_hessenberg_recollement_final import (
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.frame_zorn.ensembles_frame_extension_finale import extension_absurde, _u_inclus_reunion
...
# @livre Ch.III §6.3 Demo.2 | E III.48 L.29-30 | PDF p.151  (réalisation du témoin canonique Y ⊂ E∖F équipotent à F)
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.3 Demo.2 | E III.48 L.25-37 | PDF p.151  (¬(𝔟<𝔞) NON vacueux : le trio géométrique est dérivé, plus supposé)
# @livre Ch.III §6.3 Demo.2 | E III.49 L.1-4 | PDF p.152
