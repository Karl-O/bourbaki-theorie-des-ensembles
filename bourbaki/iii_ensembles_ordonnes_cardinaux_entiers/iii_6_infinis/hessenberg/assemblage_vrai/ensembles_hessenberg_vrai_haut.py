...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.hessenberg.assemblage_vrai.ensembles_hessenberg_chaine_vraie import phi1_bijection_derivee
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.frame_zorn.ensembles_frame_extension_finale import cadre_ensemble
...
# @livre Ch.III §6.3 Demo.2 | E III.49 L.1-4 | PDF p.152  (décharge des résidus mécaniques de la bijection g = f∪f₁)
