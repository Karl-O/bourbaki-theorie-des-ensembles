...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.hessenberg.coeur.ensembles_hessenberg_extension import complement_grand
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.3 Demo.2 | E III.48 L.25-37 | PDF p.151  (extension du maximal : ¬(𝔟<𝔞) — version VACUEUSE, cf. avertissement)
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.3 Th.2 | E III.47 L.30-32 | PDF p.150  (cible a²=a — montage VACUEUX, ne compte pas comme acquis ; cf. avertissement)
