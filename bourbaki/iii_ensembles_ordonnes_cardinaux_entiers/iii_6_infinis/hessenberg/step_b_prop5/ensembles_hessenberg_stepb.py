...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.3 Demo.2 | E III.49 L.3-4 | PDF p.152  (la contradiction complète en falsum explicite, sous témoins)
def chaine_falsum_sous_temoins(E_set="E", phi0="phi0", S="S0", U="Ucadre",
                               psi="psi", u="uwit", cible=None, via_reunion=False):
    ...
    base = extension_absurde_chainee(E_set, phi0, psi, S, U, u,
                                     via_reunion=via_reunion)   # ⊢ ¬(u∈U)
...
# @livre Ch.III §6.3 Demo.2 | E III.49 L.3-4 | PDF p.152  (inventaire des hypothèses honnêtes de la contradiction)
