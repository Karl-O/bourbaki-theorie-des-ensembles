...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.hessenberg.step_b_prop5.ensembles_hessenberg_stepb import chaine_falsum_sous_temoins
...
# ════════════════════════════════════════════════════════════════════════════
def _cadre(vS, vU, via_reunion):
    """Le cadre F, tague (defaut) ou REUNION (deblocage B2)."""
    if via_reunion:
        ...
        return cadre_ensemble_reunion(vS, vU)
    return cadre_ensemble(vS, vU)


def _psi_free_residuals(b0, vphi0, vpsi, vS, vU, via_reunion=False):
...
# @livre Ch.III §6.3 Demo.2 | E III.49 L.1-4 | PDF p.152  (pelage des témoins ψ et u de la contradiction, cadre en somme disjointe)
def negation_strict_sous_temoins_UF(E_set="E", phi0="phi0", psi="psi", S="S0",
                                    U="Ucadre", u="uwit", via_reunion=False):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.hessenberg.coeur.ensembles_hessenberg_structural_discharge import U_non_vide
