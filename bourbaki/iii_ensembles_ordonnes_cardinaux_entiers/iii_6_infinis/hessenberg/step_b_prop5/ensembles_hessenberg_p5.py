...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.3 Demo.2 | E III.49 L.1-4 | PDF p.152  (pelage des témoins ψ et u sur le cadre PLAT — mur architectural tombé)
def negation_strict_sous_temoins_UF_plat(E_set="E", phi0="phi0", psi="psi", S="S0",
    ...
    """
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.hessenberg.coeur.ensembles_cadre_plat import chaine_falsum_plat, cadre_plat
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.hessenberg.coeur.ensembles_cadre_plat import cadre_plat_bijection
