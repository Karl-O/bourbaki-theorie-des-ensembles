...
def _infini_ensemble_de_inclus(E_set, S, tU):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.entiers_infinis.iii_6_3_infinis_denombrables.ensembles_infinis_props import infini_ensemble_monotone_cond
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.entiers_infinis.iii_6_3_infinis_denombrables.ensembles_infinis import est_infini_ensemble, est_infini
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.3 Demo.2 | E III.48 L.25-30 | PDF p.151  (¬(𝔟<𝔞) sous la seule donnée maximale — témoin Y éliminé)
def negation_strict_sous_maximal(E_set="E", phi0="phi0", S="S0", U="Ucadre"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.hessenberg.coeur.ensembles_cadre_plat import cadre_plat, cadre_plat_blocs_disjoints
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.hessenberg.assemblage_vrai.ensembles_hessenberg_recollement_final import _b_le_complement
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.hessenberg.coeur.ensembles_cadre_plat import commutativite_intersection_t
...
def _prouver_dom_disj(vphi0, vS, vU, dom0, inter_SU, inter_US):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.hessenberg.coeur.ensembles_cadre_plat import (
    ...
    from bourbaki.i_description_mathematique_formelle.i_5_theories_egalitaires.i_5_2_tactiques_abrege_egalite import composer_egalites as ce
    SxS = E.produit(vS, vS)
...
# @livre Ch.III §6.3 Demo.2 | E III.49 L.1-4 | PDF p.152  (fin de la démonstration : conclusion E-seule)
def hessenberg_a_carre_egal_a_REEL(E_set="E"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.hessenberg.coeur.ensembles_hessenberg_maximal_card import maximal_carre_egal
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.hessenberg.coeur.ensembles_hessenberg_structural_discharge import (
        card_inclus_inf_egal,
    )
