...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.3 Demo.2 | E III.48 L.23-24 | PDF p.151  (toute chaîne de 𝔐 admet le majorant-recollement (⋃S,⋃φ))
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.3 Demo.2 | E III.48 L.23-24 | PDF p.151  (« on vérifie aussitôt que 𝔐 est un ensemble inductif »)
