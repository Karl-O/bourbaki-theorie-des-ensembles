...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.1 Def.- | E III.45 L.21-22 | PDF p.148  (« Nous désignerons par N l'ensemble des entiers » — ℕ réalisé comme terme τ)
...
def _appartenance_NN_cache(x="x", Y="y"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_recurrence_c61_existence_n.ensembles_predecesseur_prop2 import N_existe
