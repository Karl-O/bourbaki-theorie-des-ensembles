...
def cardinal_infini_existe(a="a", X="X"):
    ...
    from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import composantes_conjonction
    vX = var(X)
...
def _coll_fini(x="x"):
    ...
    from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import coll
...
# @livre Ch.III §6.1 Th.1 | E III.45 L.19-20 | PDF p.148
# @livre Ch.III §6.1 Demo.1 | E III.45 L.5-13 | PDF p.148  (la « Remarque » L.5-13 EST la démonstration : « Les remarques qui précèdent prouvent alors le théorème suivant », L.19)
