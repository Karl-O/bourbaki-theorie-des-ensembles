...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.entiers_infinis.iii_6_1_n_objet_existence.ensembles_ensemble_NN import ensemble_NN, appartenance_NN
...
# @livre Ch.III §6.1 Rem.- | E III.45 L.23-24 | PDF p.148  (« Quand on considère N comme ensemble ordonné, il s'agit toujours de l'ordre (dit usuel) » : ≤ des cardinaux induit sur ℕ)
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.ordinal_cardinal.realisation_segment.ensembles_gate_onto_top import bon_ordre_intervalle_close
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.ordinal_cardinal.ordinal_cardinal_correspondance.ensembles_ordinal_cardinal_correspondance import ordre_induit_intervalle
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.ordinal_cardinal.ordinal_cardinal_correspondance.ensembles_ordinal_cardinal_bon_ordre import bon_ordre_donne_clause_plus_petit
...
# @livre Ch.III §6.2 Demo.C62 | E III.46 L.15-16 | PDF p.149  (« L'ensemble N étant bien ordonné, on peut lui appliquer le critère C60 » : le bon ordre de ℕ, hypothèse (a) irréductible de C62)
def n_bien_ordonne():
    ...
    from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import alpha_egal
