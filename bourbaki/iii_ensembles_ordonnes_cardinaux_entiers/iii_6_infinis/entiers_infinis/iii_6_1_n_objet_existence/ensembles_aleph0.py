...
from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import conjonction_intro as _conj_intro
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.ordinal_cardinal.bon_ordre_intervalle.ensembles_clause_plus_petit_monotonie import (
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.1 Rem.- | E III.45 L.21-22 | PDF p.148  (« Le cardinal de N se note aussi ℵ₀ » : ℵ₀ := Card(ℕ), sur le ℕ concret ensemble_NN)
...
def s_injective_safe(u="m0", up="m0p"):
    ...
    NN = ensemble_NN()
    s = _s(NN)
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.entiers_infinis.iii_6_1_n_objet_existence.ensembles_ensemble_NN import appartenance_NN_instanciee
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.1 Demo.1 | E III.45 L.10-13 | PDF p.148  (ℵ₀ = ℵ₀+1, équation de Dedekind pour le ℕ concret — cœur de « l'ensemble des entiers E est un ensemble infini »)
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.1 Demo.1 | E III.45 L.10-13 | PDF p.148  (« l'ensemble des entiers E est un ensemble infini » : ¬Fini(ℵ₀) réalisé sans A4)
def aleph0_infini():
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.entiers_infinis.iii_6_3_infinis_denombrables.ensembles_infinis_props import cardinal_egal_succ_implique_infini
