...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (Terme, var, egal, et, ou, non, impl, equiv)
from bourbaki.i_description_mathematique_formelle.i_2_theoremes.noyau import noyau_abrege as N

from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.definitions_cardinaux.ensembles_cardinaux import est_cardinal, cardinal, inf_egal_card
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_1_definitions_premiers_entiers.ensembles_entiers import est_fini, est_fini_ensemble, successeur
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.1 Rem.- | E III.45 L.3-4 | PDF p.148  (caractérisation de Dedekind, sens facile — conséquence de la Déf. 1, hors texte du livre)
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.1 Rem.- | E III.45 L.3-4 | PDF p.148  (Dedekind, sens dur — conséquence de la Déf. 1, hors texte du livre)
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.1 Rem.- | E III.45 L.3-4 | PDF p.148  (Dedekind complète : infini ⇔ a=a+1, pour un cardinal — hors texte du livre)
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.1 Ax.A4 | E III.45 L.14-15 | PDF p.148  (conséquence directe de A4 : un cardinal infini existe)
def existe_cardinal_infini(a="a", X="X"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.entiers_infinis.iii_6_1_n_objet_existence.ensembles_N_collectivise import cardinal_infini_existe
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.1 Rem.- | E III.45 L.5-13 | PDF p.148  (monotonie de l'infini — voisine de la remarque de la Déf. 1)
...
# @livre Ch.III §6.4 Prop.1 | E III.49 L.23-27 | PDF p.152  (PARTIEL : seule la 1ère assertion « toute partie d'un dénombrable est dénombrable », sous report explicite)
def sous_ensemble_denombrable_cond(A="A", B="B"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_2_finis_props.ensembles_finis_props import partie_inf_egal_card
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.4 Rem.- | E III.49 L.28-29 | PDF p.152  (« On a déjà vu (III, p. 48, lemme 1) que, pour tout cardinal infini 𝔞, on a Card(N) ≤ 𝔞 » — énoncé-cible, REPORTÉ)
