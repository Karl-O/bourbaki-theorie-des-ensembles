...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.3 Demo.2 | E III.48 L.23-24 | PDF p.151  (pont couple→égalité d'ensembles pour l'image du recollement de chaîne)
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.3 Demo.2 | E III.48 L.23-24 | PDF p.151  (pont couple→égalité d'ensembles pour le domaine du recollement de chaîne)
