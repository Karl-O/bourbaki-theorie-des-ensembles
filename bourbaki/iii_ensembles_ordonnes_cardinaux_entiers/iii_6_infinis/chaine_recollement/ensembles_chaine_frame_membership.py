...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.3 Demo.2 | E III.48 L.23-24 | PDF p.151  (le recollement de chaîne ⋃φ est une bijection de (⋃S)×(⋃S) sur ⋃S)
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.3 Demo.2 | E III.48 L.19-24 | PDF p.151  ((⋃S,⋃φ) appartient à 𝔐 : frame-membership du majorant de chaîne)
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.3 Demo.2 | E III.48 L.23-24 | PDF p.151  (« 𝔐 est un ensemble inductif » — toute chaîne majorée ; reporté, cf. docstring)
def frame_inductif_chaine(E_set="E", C="C", m="m", x="x", y="y", z="z"):
    ...
    hyps ; theorie=22."""
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.hessenberg.coeur.ensembles_hessenberg_inductivite import frame_inductif
