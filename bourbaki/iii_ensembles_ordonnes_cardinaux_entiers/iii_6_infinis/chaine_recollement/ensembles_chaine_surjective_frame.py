...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.3 Demo.2 | E III.48 L.23-24 | PDF p.151  (recollement de chaîne : surjectivité couple-native de ⋃φ sur ⋃S)
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.3 Demo.2 | E III.48 L.23-24 | PDF p.151  (recollement de chaîne : couverture du domaine (⋃S)×(⋃S), chaîne dirigée)
