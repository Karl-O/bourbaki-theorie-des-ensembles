...
# @livre Ch.III §6.1 Rem.- | E III.45 L.5-9 | PDF p.148  (« si 𝔞 est un cardinal infini, et n un entier quelconque, on ne peut avoir 𝔞 ≤ n ; on a donc n < 𝔞 » — ici n ≤ 𝔟)
...
# @livre Ch.III §6.1 Rem.- | E III.45 L.5-9 | PDF p.148  (instance n=2)
...
# @livre Ch.III §6.1 Rem.- | E III.45 L.5-9 | PDF p.148  (instance n=3)
