...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.ordinal_cardinal.ordinal_cardinal_correspondance.ensembles_cardinal_pas_entre_univ import cardinal_pas_entre_garde
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §4.2 Prop.2 | E III.31 L.15-17 | PDF p.134
