...
def prop4_ordre_iso(a="aP4iso", b="bP4iso", x="xP4iso", xp="xpP4iso",
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_5_calcul_entiers.iii_5_intervalles_comptage.ensembles_prop5_prop4_iii5 import prop4_translation_bien_definie
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_5_calcul_entiers.iii_5_2_inegalites_ordre_soustraction.ensembles_prop4_strict_iii5 import prop4_translation_stricte
    va, vb, vx, vxp, vy = _t(a), _t(b), _t(x), _t(xp), _t(y)
    ab = somme_cardinale_binaire(va, vb)
    seg_dom = E.intervalle_entiers(ZERO, vb)
