...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.definitions_cardinaux.ensembles_cardinaux import est_cardinal, inf_egal_card, cardinal
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_1_definitions_premiers_entiers.ensembles_entiers import successeur, ZERO, est_fini, est_entier
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_1_definitions_premiers_entiers.ensembles_fini_successeur import successeur_est_un_cardinal
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_6_infinis.entiers_infinis.iii_6_1_n_objet_existence.ensembles_aleph0 import card_egal_succ_card_diff
...
def _mem_int_t(a, b, x):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_1_definitions_premiers_entiers.ensembles_entiers_theoremes import _membre_intervalle
...
def _zero_inf_egal_card(a):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.ordre_cardinaux.ensembles_cardinaux_bornes import zero_inf_egal
    va = _t(a)
...
def _intervalle_zero_zero():
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_1_definitions_premiers_entiers.ensembles_fini_zero import zero_est_un_cardinal
...
def _succ_non_dans_intervalle_zero(b="b"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_1_definitions_premiers_entiers.ensembles_entiers_theoremes import intervalle_implique_borne_sup
    vb = _t(b)
    sb = successeur(vb)
...
# @livre Ch.III §5.3 Prop.5 | E III.38 L.1-9 | PDF p.141
...
def prop4_translation_croissante(a="a", x="x", x2="xp"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_5_calcul_entiers.iii_5_1_somme_produit_entiers.ensembles_calcul_entiers_props import somme_binaire_monotone_droite
    va, vx, vx2 = _t(a), _t(x), _t(x2)
    sbmd = N.generalisation("asbm", N.generalisation("bsbm", N.generalisation("csbm",
        somme_binaire_monotone_droite("asbm", "bsbm", "csbm"))))
