...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_1_definitions_premiers_entiers.ensembles_entiers import (divise, quotient_division,
...
def condition_division_euclidienne(a, b, q, r):
    ...
    b·q + r restant codé opaque — RÉSERVE PÉRIMÉE, voir `divise` : le produit
    cardinal binaire est disponible depuis l'arithmétique cardinale, mais des
    THÉORÈMES dépendent de la forme opaque."""
