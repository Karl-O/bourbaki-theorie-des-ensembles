...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.II §5.6 Prop.9 | E II.36 L.25-30 | PDF p.87
...
def produit_union_carre(a="A", b="B", z="z"):
    ...
    from bourbaki.i_description_mathematique_formelle.i_5_theories_egalitaires.i_5_2_tactiques_abrege_egalite import congruence_terme, composer_egalites
    from bourbaki.ii_theorie_des_ensembles.ii_1_relations_collectivisantes.ii_1_algebre_booleenne.ensembles_algebre_booleenne import associativite_reunion
    vA, vB = _t(a), _t(b)
    AB = E.reunion(vA, vB)
