...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_1_relations_ordre.iii_1_2_caracterisation_ordre.ensembles_prop1_caracterisation import (
...
# @livre Ch.R §6 Prop.- | E.R.26 item 1 (conditions sur le graphe : a') C∘C⊂C, b') C∩C⁻¹=Δ) | PDF p.329
