...
def majorant_de_sur_domine(G="G", A="A", B="B", E_set="E", m="m", x="x", u="u",
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_1_relations_ordre.ordre_treillis.ensembles_ordre_relation import transitivite_rel
...
def majorant_reunion_iff(G="G", A="A", B="B", E_set="E", m="m", x="x"):
    ...
    from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import ou as _ou
    from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import (
