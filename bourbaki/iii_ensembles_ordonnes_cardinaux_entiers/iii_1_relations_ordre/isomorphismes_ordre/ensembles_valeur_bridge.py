...
from bourbaki.i_description_mathematique_formelle.i_2_theoremes.noyau.noyau_abrege import alpha_tau
...
# (outil de formalisation : α-renommage du liant-τ de valeur, pour chaîner les écritures
#  de f(x) dans compatible_ordre — déf. d'isomorphisme d'ordre ; rien de neuf du livre)
