...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import Terme, var, et, equiv, impl, appartient
from bourbaki.i_description_mathematique_formelle.i_2_theoremes.noyau import noyau_abrege as N
from bourbaki.ii_theorie_des_ensembles.ii_1_relations_collectivisantes import ensembles_abrege as E
from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import equivalence_avant, instancie
...
# (outil de formalisation : pont de liant-valeur j↔y au service de compatible_ordre,
#  cœur de la définition d'isomorphisme d'ensembles ordonnés ; rien de neuf du livre)
