...
# @livre Ch.III §1.3 Rem.- | E III.5 L.5-6 | PDF p.108
# (le 2ᵉ marqueur : petit texte « non(x≤y) pas nécessairement équivalente à y<x » —
...
# @livre Ch.R §6 Def.- | E.R.27 item 4 (intervalle semi-ouvert à droite [a,b[) | PDF p.330
...
# @livre Ch.III §1.13 Def.- | E III.14 L.31-36 | PDF p.117
# @livre Ch.R §6 Def.- | E.R.27 item 4 (intervalle semi-ouvert à gauche ]a,b]) | PDF p.330
...
# @livre Ch.R §6 Def.- | E.R.27 item 4 (intervalle ouvert illimité à gauche ]<-,a[) | PDF p.330
...
# @livre Ch.R §6 Def.- | E.R.27 item 4 (intervalle ouvert illimité à droite ]a,->[) | PDF p.330
...
# @livre Ch.R §6 Def.- | E.R.27 item 4 (E = ]<-,->[ : intervalle ouvert illimité dans les deux sens) | PDF p.330
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §1.3 Def.- | E III.5 L.28-30 | PDF p.108
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §1.4 Def.- | E III.6 L.21-29 | PDF p.109
