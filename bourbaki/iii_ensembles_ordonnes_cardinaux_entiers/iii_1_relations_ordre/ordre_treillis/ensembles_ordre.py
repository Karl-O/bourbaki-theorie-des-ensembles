...
from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import (instancie, conjonction_intro, conjonction_elim_gauche,
...
# @livre Ch.R §6 Prop.- | E.R.26 item 1 (préordre : équivalence associée R, ordre associé sur E/R) | PDF p.329
