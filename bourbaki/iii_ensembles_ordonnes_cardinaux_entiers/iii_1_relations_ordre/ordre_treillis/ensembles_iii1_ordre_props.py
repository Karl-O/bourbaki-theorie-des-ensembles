...
# (vérification du « comme on le vérifie aussitôt » de l'Exemple 2 : la relation induite
#  « R{x,y} et x∈E et y∈E » est une relation d'ordre)
...
# (moitié PRÉORDRE du « est une relation d'ordre … comme on le vérifie aisément » ;
#  l'antisymétrie est close dans ensembles_ordre_produit_antisym.py)
