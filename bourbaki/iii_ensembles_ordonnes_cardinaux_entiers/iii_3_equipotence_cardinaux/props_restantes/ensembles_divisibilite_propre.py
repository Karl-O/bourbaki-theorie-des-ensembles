...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import Terme, var, egal, et, ou, non, existe, impl
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_1_definitions_premiers_entiers.ensembles_entiers import est_fini, DEUX, UN
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_1_definitions_premiers_entiers.ensembles_fini_un import fini_un, un_egale_card_singleton
...
# ══════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §5.6 Def.1 | E III.39 L.20-23 | PDF p.142
#   (« … on dit que a est multiple de b, ou que a est divisible par b, ou que b est
#    un diviseur de a, ou que b divise a » — ici la variante « propre » assise sur
#    le VRAI produit cardinal binaire Card(b×q), avec quotient fini explicite.)
...
# @livre Ch.III §5.6 Rem.- | E III.39 L.32-33 | PDF p.142
#   (« Les entiers multiples de 2 sont dits pairs, les autres impairs ; ces derniers
#    sont de la forme 2n + 1, d'après le th. 1. »)
