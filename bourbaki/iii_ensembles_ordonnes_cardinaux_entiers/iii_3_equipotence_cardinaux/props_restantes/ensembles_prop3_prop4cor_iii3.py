...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (var, egal, et, appartient, impl, existe, Terme)
...
from bourbaki.ii_theorie_des_ensembles.ii_3_correspondances.ii_3_8_retractions_sections.ensembles_retractions import retraction_implique_injective
...
# @livre Ch.III §3.2 Prop.3 | E III.25 L.40-43 | PDF p.128
#   (énoncé L.40-41 + démonstration L.42-43 « il existe une section s associée à f » ;
#    lignes recalées campagne @livre 2026-07 : Prop. 3 précède la Déf. 3 (L.45-48).)
