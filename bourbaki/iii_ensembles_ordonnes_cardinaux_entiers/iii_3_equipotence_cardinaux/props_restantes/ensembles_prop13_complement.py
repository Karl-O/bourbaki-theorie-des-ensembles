...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.ordinal_cardinal.realisation_segment.ensembles_realisation_segment_close import (
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_4_prop8_successeur.ensembles_copie_marquee import _eq_sym_t
...
# ══════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §3.6 Demo.13 | E III.29 L.55-58 | PDF p.132
#   (démonstration du sens direct : « la relation a ≥ b signifie qu'il existe une
#    partie B de a équipotente à b, c'est-à-dire que a est équipotent à l'ensemble
#    somme de b et d'un ensemble C. » — construction du complément certifiée ici.)
...
#   (sens DIRECT (⇒) FERMÉ : a ≥ b ⇒ (∃c) a = b + c, sous les gardes « cardinaux ».)
