...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (var, app, egal, et, impl, equiv, pourtout,
                                       appartient)
...
# @livre Ch.III §3.2 Def.- | E III.25 L.38-39 | PDF p.128
#   (« Par abus de langage, on dit que le cardinal b est la borne supérieure de la
#    famille (a_ι)_{ι∈I} de cardinaux et on le note sup a_ι. » — lignes recalées
#    campagne @livre 2026-07 : ce passage précède Prop. 3 (L.40-43) et Déf. 3 (L.45-48).)
