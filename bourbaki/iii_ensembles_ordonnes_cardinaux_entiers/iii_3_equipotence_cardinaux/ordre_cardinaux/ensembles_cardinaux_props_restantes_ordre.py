...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (Terme, var, egal, et, ou, impl, existe, pourtout)
...
#   (démonstration du Théorème 1 : « Comme R{x,x} est vraie pour tout cardinal … »
#    via bon ordre de A = ⋃x et segments φ(x) — occupe le reste de la page.)
# @livre Ch.III §3.2 Demo.1 | E III.25 L.1-2 | PDF p.128
#   (fin de la démonstration : « contredisant la définition de φ(x). Comme
#    l'ensemble des segments de A est bien ordonné par inclusion, le théorème
#    est démontré. »)
