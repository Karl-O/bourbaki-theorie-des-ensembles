...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_2_monotonie.ensembles_somme_monotone import inf_egal_somme_invariant
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_2_monotonie.ensembles_arith_cardinale_props_produit_monotone import (
...
# ═══════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §3.6 Prop.14 | E III.30 L.4-8 | PDF p.133
#   (« Soient (a_ι) et (b_ι) deux familles de cardinaux … a_ι ≥ b_ι pour tout ι ;
#    on a alors Σ a_ι ≥ Σ b_ι et P a_ι ≥ P b_ι. » — ici le CAS BINAIRE, somme.)
# @livre Ch.III §3.6 Demo.14 | E III.30 L.9-11 | PDF p.133
#   (démonstration du livre au niveau familles (inclusions de produits/réunions
#    disjointes) ; la version binaire est certifiée dans ce module.)
...
# ═══════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §3.6 Prop.14 | E III.30 L.4-8 | PDF p.133
#   (cas binaire, PRODUIT : a ≤ a₁ et b ≤ b₁ ⇒ ab ≤ a₁b₁.)
