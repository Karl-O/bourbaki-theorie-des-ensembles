...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import var, egal, et, appartient, existe, inclus, Terme
from bourbaki.i_description_mathematique_formelle.i_2_theoremes.noyau import noyau_abrege as N
from bourbaki.ii_theorie_des_ensembles.ii_1_relations_collectivisantes import ensembles_abrege as E
from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege import inclusion_reflexive, syllogisme
...
from bourbaki.i_description_mathematique_formelle.i_4_theories_quantifiees.i_4_3_tactiques_abrege_quantif import (alpha_existe, existe_elimination,
                                      existe_commute, et_existe_droite,
                                      congruence_existe)
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.definitions_cardinaux.ensembles_cardinaux import (est_bijection_de, equipotent, est_injection_de,
                                 inf_egal_card)
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.equipotence.ensembles_bijection import _cut, _premier_dans_X
...
#   (paragraphe « La relation "X est équipotent à une partie de Y" est équivalente
#    à "il existe une injection de X dans Y" » — propriétés directes de ≤ :
#    Eq ⇒ ≤ (bijection = injection) ; infra de la relation du Théorème 1.)
...
# @livre Ch.III §3.2 Demo.1 | E III.24 L.22-48 | PDF p.127
#   (transitivité de ≤ : composée de deux injections — utilisée implicitement par
#    la démonstration du Théorème 1 (« R{x,y} et R{y,z} implique R{x,z} », p. 23,
#    et bon ordre p. 24) ; infra certifiée ici.)
