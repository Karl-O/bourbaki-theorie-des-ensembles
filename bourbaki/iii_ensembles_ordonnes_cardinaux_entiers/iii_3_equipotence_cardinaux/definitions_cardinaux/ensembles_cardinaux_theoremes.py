...
from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import (conjonction_intro, equivalence_avant, instancie)
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.definitions_cardinaux.ensembles_cardinaux import equipotent, cardinal, est_injection_de, inf_egal_card
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.equipotence.ensembles_equipotence import (equipotence_reflexive, diagonale_fonctionnelle,
                                   diagonale_domaine, diagonale_injective, diagonale_image)
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.equipotence.ensembles_bijection import equipotence_symetrique, equipotence_transitive
...
# @livre Ch.III §3.1 Demo.1 | E III.23 L.36-41 | PDF p.126
#   (« Comme Eq(X, X) est vraie, Card (X) est équipotent à X (I, p. 33, schéma S5).
#    Nous avons donc démontré le résultat suivant : » — démonstration de Prop. 1.)
