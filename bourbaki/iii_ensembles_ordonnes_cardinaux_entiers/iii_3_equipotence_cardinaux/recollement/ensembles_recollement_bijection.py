...
l'INJECTIVITÉ et l'IMAGE.  Lemmes réutilisables (Cantor–Bernstein ET Cor. 1 de la
Prop. 10, E III.28 : a^(b+c)=a^b·a^c).
...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (Terme, var, egal, et, ou, non,
...
#   (infra du cas binaire a^(b+c) = a^b·a^c : valeur / image / injectivité du
#    recollement G∪H de deux graphes fonctionnels à domaines disjoints.)
...
#   (infra de la démonstration machine de Cantor–Bernstein : injectivité du
#    recollement h = (f|D) ∪ (g⁻¹|(A∖D)), images disjointes.)
