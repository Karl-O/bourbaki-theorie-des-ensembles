"""§III.3.3 — RECOLLEMENT le long de la somme disjointe (infra pour le Cor. 1
de la Prop. 10, E III.28 : a^(b+c) = a^b · a^c, cas binaire).
...
from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege import syllogisme, antecedent_consequent
...
# @livre Ch.R §4 Prop.- | E R.22 item 15 (recollement de deux applications à domaines disjoints) | PDF p.325
# @livre Ch.III §3.5 Cor.1 | E III.28 L.39-44 | PDF p.131
#   (infra du cas binaire a^(b+c) = a^b·a^c du Cor. 1 de la Prop. 10 : découpage /
#    recollement d'une application définie sur la somme disjointe b⊔c.)
