...
from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import (conjonction_intro, equivalence_arriere, instancie)
...
# @livre Ch.III §3.1 Rem.- | E III.23 L.22-22 | PDF p.126
#   (« c'est donc une relation d'équivalence, réflexive dans tout ensemble. » —
#    infrastructure générale des relations d'équivalence (E.II.6) appliquée à Eq.)
