...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import var, egal, et, impl, Terme
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.equipotence.ensembles_bijection import (composee_fonctionnelle,
...
#   (« la composée de deux bijections est une bijection (II, p. 19, th. 1) » —
#    la forme implicative fermée invoquée par la transitivité de Eq.)
