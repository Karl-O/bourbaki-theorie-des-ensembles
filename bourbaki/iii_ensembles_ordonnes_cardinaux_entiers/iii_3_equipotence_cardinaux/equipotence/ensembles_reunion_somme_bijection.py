...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (Terme, var, egal, et, non, appartient,
...
def _subst_terme(term, old_t, new_v):
    ...
    if getattr(term, "tag", None) == "app":
        from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import app as _app
...
# @livre Ch.III §3.3 Demo.- | E III.26 L.17-19 | PDF p.129
#   (démonstration du corollaire de la Prop. 4 : « il existe une application de la
#    somme S des E_ι sur leur réunion (II, p. 30) » — ici la forme binaire close :
#    A∩B=∅ ⇒ Eq(A∪B, A⊔B), bijection canonique réunion ↔ somme disjointe.)
