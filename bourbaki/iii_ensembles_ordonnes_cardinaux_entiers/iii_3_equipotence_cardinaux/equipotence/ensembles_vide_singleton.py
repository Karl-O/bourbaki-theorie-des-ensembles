...
# @livre Ch.III §3.1 Ex.1 | E III.23 L.44-48 | PDF p.126
#   (« Exemples 1) On note 0 le cardinal Card(∅). Le seul ensemble équipotent à ∅
#    étant ∅ (II, p. 10 et p. 14), on a 0 = Card(∅) = ∅. » — d'où, avec l'Ex. 2
#    p. 24, la distinction 0 ≠ 1 certifiée ici : ¬Eq(∅, {∅}).)
