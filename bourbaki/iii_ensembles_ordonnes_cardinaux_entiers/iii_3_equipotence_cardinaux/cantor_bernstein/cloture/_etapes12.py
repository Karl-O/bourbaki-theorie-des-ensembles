...
#   (Cantor–Bernstein, démonstration machine : étapes 1-2 de la clôture —
#    rétraction g⁻¹∘g = id puis morceau g⁻¹|(A∖D) ; énoncé du livre aux lignes citées.)
...
def _image_dans_img_terme(g, x):
    ...
    from bourbaki.ii_theorie_des_ensembles.ii_3_correspondances.ii_3_1_graphes_correspondances.ensembles_correspondances import image_dans_img
...
def morceau_gI(a="A", b="B", f="f", g="g"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.cantor_bernstein.ensembles_cantor_bernstein_fin import pivot_AmoinsD
