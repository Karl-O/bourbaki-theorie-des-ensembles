...
(`iii_3_equipotence_cardinaux/recollement/ensembles_recollement_bijection.py`) : la réunion
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.III §6.3 Demo.2 | E III.48 L.24-48 | PDF p.151
#   (infra de la démonstration du Th. 2 (Hessenberg, a·a = a) : « 𝔐 est un ensemble
#    inductif (cf. III, p. 20, Exemple 2) » — l'union d'une chaîne de prolongements
#    injectifs reste injective, certifié ici en version famille dirigée.)
