...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (Terme, var, egal, et, non, appartient, existe,
                                       inclus, subst_t)
...
# @livre Ch.III §3.6 Cor.1 | E III.30 L.12-14 | PDF p.133
#   (« Pour toute partie J de I, on a Σ_{ι∈J} a_ι ≤ Σ_{ι∈I} a_ι. Si en outre on a
#    a_ι ≠ 0 pour tout ι∈I−J, on a P_{ι∈J} a_ι ≤ P_{ι∈I} a_ι. » — cas binaire
#    somme : a ≤ a+b, certifié ici.)
# @livre Ch.III §3.6 Demo.- | E III.30 L.15-17 | PDF p.133
#   (démonstration du Cor. 1 : poser b_ι = a_ι sur J et 0 (resp. 1) hors de J,
#    appliquer la Prop. 14 ; ici témoins injectifs directs.)
...
# @livre Ch.III §3.6 Cor.1 | E III.30 L.12-14 | PDF p.133
#   (cas binaire produit : a ≤ a·b si b ≠ 0, certifié ici.)
