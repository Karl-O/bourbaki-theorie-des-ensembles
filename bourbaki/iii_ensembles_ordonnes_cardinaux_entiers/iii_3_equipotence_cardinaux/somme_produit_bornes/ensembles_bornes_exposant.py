...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (Terme, var, tau, egal, et, ou, non, impl,
...
#   (bornes inconditionnelles a ≤ a^b (b≠0) et 1 ≤ a^b : conséquences directes de
#    la Déf. 4 (a^b = Card des applications de b dans a), non énoncées telles
#    quelles dans le livre ; injections constantes construites ici.)
...
def _Fba_non_vide_a(a="a", b="b"):
    ...
    from bourbaki.ii_theorie_des_ensembles.ii_1_relations_collectivisantes.ensembles_vide import non_vide_ssi_element
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.ordre_cardinaux.ensembles_cardinaux_un_borne import un_inf_egal
    va, vb = _t(a), _t(b)
