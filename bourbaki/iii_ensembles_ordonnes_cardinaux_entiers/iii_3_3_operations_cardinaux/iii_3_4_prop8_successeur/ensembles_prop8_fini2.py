...
from bourbaki.ii_theorie_des_ensembles.ii_4_reunion_intersection_famille.ii_4_recollement_somme.ensembles_somme_disjointe import (somme_disjointe,
                                                                   ZERO, UN)
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.definitions_cardinaux.ensembles_cardinaux import (est_bijection_de, cardinal,
                                                    equipotent)
...
# (L.11-13 : petit texte « On se gardera de croire que a+m=b+m entraîne a=b … »
#  — prose de mise en garde, rien à formaliser ici ; le cas fini est en III.4/III.5.)
# @livre Ch.III §3.4 Rem.- | E III.28 L.11-13 | PDF p.131
