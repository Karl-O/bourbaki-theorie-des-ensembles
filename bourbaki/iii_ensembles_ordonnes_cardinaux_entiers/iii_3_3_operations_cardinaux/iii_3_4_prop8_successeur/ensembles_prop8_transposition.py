...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (Terme, var, egal, et, appartient,
                                       existe, pourtout)
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.equipotence.ensembles_composee_bijection import composee_bijection
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_4_prop8_successeur.prop8_coeur import eq_cas_fixe_implique_eq
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_4_prop8_successeur.prop8_coeur._marqueurs import m_dans_AS
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_4_prop8_successeur.ensembles_copie_marquee import (
...
def _hstar_in_dom_tau(b, h, tau):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_4_prop8_successeur.ensembles_prop8_assemblage import hstar_dans_BS
    vh, vtau = _t(h), _t(tau)
    BS = _BS(b)
...
# (CAS 2 de la démo de la Prop.8 : « Sinon A = C ∪ {v}, B = C ∪ {u} » — l'échange
#  a0↦b0 du livre est réalisé par composition avec la transposition τ.)
# @livre Ch.III §3.4 Demo.8 | E III.28 L.9-10 | PDF p.131
...
def prop8_via_transposition_mod_HT(a="A", b="B", h=_H, tau=_TAU):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_4_prop8_successeur.ensembles_prop8_assemblage import (
