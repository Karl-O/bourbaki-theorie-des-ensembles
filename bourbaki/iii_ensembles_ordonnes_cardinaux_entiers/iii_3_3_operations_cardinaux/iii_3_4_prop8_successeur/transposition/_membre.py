...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import Terme, var, egal, et, ou, non, appartient
...
# (appartenance au graphe de la transposition — brique du CAS 2 de la démo de la Prop.8.)
...
def transpo_membre(s="S", p="p", q="q", x="x", y="y"):
    ...
    from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import equiv_neg, demorgan_ou
...
def _neg_couple_eq_via_xy(vx, vy, va, thm_xy):
    ...
    from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import equiv_neg
