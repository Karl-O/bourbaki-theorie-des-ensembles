...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import Terme, var, egal, impl, et
...
# ═══════════════════════════════════════════════════════════════════════════════
# (réduction de la Prop.8 au lemme back-and-forth Eq(A⊔{vide},B⊔{vide}) => Eq(A,B).)
# @livre Ch.III §3.4 Demo.8 | E III.28 L.6-10 | PDF p.131
