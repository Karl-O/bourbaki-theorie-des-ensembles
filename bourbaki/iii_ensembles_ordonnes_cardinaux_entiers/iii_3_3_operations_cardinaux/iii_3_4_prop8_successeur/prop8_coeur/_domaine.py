...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (var, egal, et, appartient, existe, inclus)
...
# (conjoint DOMAINE de la restriction g = h|(A×{0}) — CAS 1 de la démo de la Prop.8.)
