...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (var, egal, et, ou, non, appartient, existe, inclus)
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_4_prop8_successeur.prop8_coeur._marqueurs import (
...
def _z_in_image_h(a, b, z, h):
    ...
    vu, vz = var("u"), z
    # u∈A⊔{∅}  (A×{0}⊂A⊔{∅})
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_4_prop8_successeur.prop8_coeur._incl import A0_inclus_AS
...
# (conjoint IMAGE de la restriction g = h|(A×{0}) — CAS 1 de la démo de la Prop.8.)
