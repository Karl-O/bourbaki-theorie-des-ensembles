...
from bourbaki.ii_theorie_des_ensembles.ii_4_reunion_intersection_famille.ii_4_recollement_somme.ensembles_somme_disjointe import UN, somme_disjointe
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_4_prop8_successeur.prop8_coeur._cas1 import eq_copies_cas_fixe


_STAR = E.couple(E.VIDE, UN)


# (CAS 1 complet de la démo de la Prop.8 : h fixe le marqueur => Eq(A,B).)
