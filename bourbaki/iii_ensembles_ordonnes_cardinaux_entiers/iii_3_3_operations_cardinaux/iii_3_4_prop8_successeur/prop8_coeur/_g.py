...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (Terme, var, egal, et, appartient, existe, inclus, subst_f)
...
from bourbaki.ii_theorie_des_ensembles.ii_4_reunion_intersection_famille.ii_4_recollement_somme.ensembles_somme_disjointe import ZERO
...
# (la restriction g = h|(A×{0}) et ses briques — CAS 1 de la démo de la Prop.8.)
...
def g_injective(a, b_somme, h=_H):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.definitions_cardinaux.ensembles_cardinaux import est_bijection_de  # noqa
    vh = var(h)
    va = _t(a)
    A0 = A0_terme(a)
    AS = _t(b_somme)
