...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_4_prop8_successeur.prop8_coeur._incl import (
...
# (CAS 1 de la démo de la Prop.8 : « Si u = v, on a A = B = C, d'où a = b ».)
...
def eq_copies_cas_fixe(a="A", b="B", h=_H):
    ...
    B0 = E.produit(vb, E.singleton(__import__(
        "bourbaki.ii_theorie_des_ensembles.ii_4_reunion_intersection_famille.ii_4_recollement_somme.ensembles_somme_disjointe", fromlist=["ZERO"]).ZERO))
    g = G_RESTR(a, h)
