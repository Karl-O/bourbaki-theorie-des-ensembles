...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (Terme, var, egal, et, ou, non, appartient, equiv)
...
# ═══════════════════════════════════════════════════════════════════════════════
# (structure « X = a+1 = partie A + un élément u » de la démo de la Prop.8 :
#  A⊔{vide} = copie de gauche + point marqué *.)
# @livre Ch.III §3.4 Demo.8 | E III.28 L.6-8 | PDF p.131
