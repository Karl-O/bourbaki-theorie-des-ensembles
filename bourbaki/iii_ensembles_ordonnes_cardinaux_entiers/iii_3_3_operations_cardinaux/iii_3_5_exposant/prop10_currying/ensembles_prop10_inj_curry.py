...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_5_exposant.prop10_currying.ensembles_prop10_close import (
...
def _Gval_egal_en_couple(vf1, vf2, va, vb, vc, b_nom, c_nom):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_5_exposant.prop10_currying.ensembles_prop10_close import _val_G
...
# (direction A du Cor.3 : a^(bc) <= (a^b)^c par l'injection de curry Λ.)
# @livre Ch.III §3.5 Demo.- | E III.29 L.7-9 | PDF p.132
