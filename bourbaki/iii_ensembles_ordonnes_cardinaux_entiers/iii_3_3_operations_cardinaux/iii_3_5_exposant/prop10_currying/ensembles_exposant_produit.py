...
# ═══════════════════════════════════════════════════════════════════════════════
# (Cor.3 a^(bc) = (a^b)^c RAMENÉ à l'équipotence des supports eq_curry ;
#  close ailleurs via inf_egal_curry/uncurry + Cantor-Bernstein.)
# @livre Ch.III §3.5 Cor.3 | E III.29 L.6-6 | PDF p.132
