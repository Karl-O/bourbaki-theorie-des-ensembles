...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (Terme, var, egal, et, impl, non, ou,
...
# (direction B du Cor.3 : (a^b)^c <= a^(bc) par l'injection d'uncurry U.)
