...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_5_exposant.prop9_exp_somme.ensembles_prop9_close import (
...
# ═══════════════════════════════════════════════════════════════════════════════
# (a^(b+c) = a^b·a^c : c'est le Cor.1 de la Prop.10 du livre — pas la Prop.9 —,
#  forme binaire ; le livre le déduit de Prop.10 + associativité du produit,
#  le projet construit la bijection Phi f ↦ (f|B, f|C) et Cantor-Bernstein.)
