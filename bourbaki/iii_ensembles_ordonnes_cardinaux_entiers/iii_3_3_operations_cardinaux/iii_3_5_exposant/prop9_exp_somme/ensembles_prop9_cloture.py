...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_5_exposant.prop9_exp_somme.ensembles_prop9_final import (
...
# (Cor.1 §3.5 conditionnel aux deux conjoints durs de la bijection Phi.)
