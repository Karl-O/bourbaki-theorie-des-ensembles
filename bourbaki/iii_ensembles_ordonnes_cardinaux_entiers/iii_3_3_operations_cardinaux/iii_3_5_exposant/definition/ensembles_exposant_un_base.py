...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (Terme, var, egal, et, appartient, existe, inclus)
...
# (démo du livre pour 1^a=1 : « il existe une application et une seule d'un ensemble
#  quelconque dans un ensemble à un élément ».)
# @livre Ch.III §3.5 Demo.11 | E III.29 L.15-16 | PDF p.132
