...
# (a^1 = a : « l'ensemble des applications d'un ensemble à un seul élément dans un
#  ensemble quelconque X est équipotent à X » — graphe constant G_v et réciproque η.)
# @livre Ch.III §3.5 Demo.11 | E III.29 L.13-14 | PDF p.132
def UN_SOURCE():
...
def gv_inclus_produit(v="c", a="A"):
    ...
    from bourbaki.ii_theorie_des_ensembles.ii_3_correspondances.ii_3_6_fonction_terme.ensembles_fonction_terme import _inst_axiome
    ...
    from bourbaki.ii_theorie_des_ensembles.ii_2_couples.ii_2_2_produit_deux_ensembles.ensembles_produit import couple_dans_produit
    hb = N.assume(body)
