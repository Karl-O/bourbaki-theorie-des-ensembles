...
from bourbaki.ii_theorie_des_ensembles.ii_2_couples.ii_2_1_definition_couples.ensembles_couples import singleton_membre, membre_paire_gauche
...
# ═══════════════════════════════════════════════════════════════════════════════
# (L.14 : titre « 5. Exponentiation des cardinaux » — prose, rien à formaliser.)
# @livre Ch.III §3.5 Rem.- | E III.28 L.14-14 | PDF p.131
# @livre Ch.III §3.5 Def.4 | E III.28 L.15-16 | PDF p.131
# (L.17-20 : petit texte du livre sur l'abus de notation a^b — prose, rien à formaliser.)
# @livre Ch.III §3.5 Rem.- | E III.28 L.17-20 | PDF p.131
# Prop.9 (« X^Y a pour cardinal a^b ») : absorbée par la définition du projet,
# qui pose a^b := Card(applications(b, a)) — l'énoncé du livre devient définitionnel.
# @livre Ch.III §3.5 Prop.9 | E III.28 L.21-24 | PDF p.131
...
# (démo du livre pour a^0=1 : « il existe une application et une seule de ∅ … ».)
# @livre Ch.III §3.5 Demo.11 | E III.29 L.12-13 | PDF p.132
# (L.18 : « On notera en particulier que l'on a 0^0 = 1 » — instance a:=0 de a^0=1.)
# @livre Ch.III §3.5 Rem.- | E III.29 L.18-18 | PDF p.132
