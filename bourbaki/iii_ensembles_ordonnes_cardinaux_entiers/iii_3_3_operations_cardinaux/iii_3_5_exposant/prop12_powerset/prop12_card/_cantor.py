...
def cantor_face_inf_egal(x="X"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.cantor.ensembles_cantor import inf_egal_parties
...
def cantor_face_non_egal(x="X"):
    ...
    CLOS, 0 hyp ; conclusion ∉ hyps ; theorie=22."""
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.cantor.ensembles_cantor import cantor_non_equipotent
    from ._bijection import card_parties_egale_deux_exp
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_5_exposant.prop12_powerset.ensembles_powerset_exp import deux
    vX = _t(x)
    PX = E.parties(vX)
...
# ═══════════════════════════════════════════════════════════════════════════════
# (Théorème 2 de Cantor, §3.6, restaté au niveau cardinal : Card X < 2^Card X ;
#  argument diagonal + pivot Prop.12 Card(P(X)) = 2^Card X.)
