...
# (le sens ρ : g ↦ g⁻¹(α) de la démo de la Prop.12 — « à toute application g de X
#  dans 2, faisons correspondre la partie g⁻¹(α) de X ».)
# @livre Ch.III §3.5 Demo.12 | E III.29 L.23-25 | PDF p.132
def preimage_un(f, x):
