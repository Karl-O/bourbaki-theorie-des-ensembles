...
# ═══════════════════════════════════════════════════════════════════════════════
# (un sens du round-trip : « les applications u∘v et v∘u sont les applications
#  identiques » — ici ρ∘χ = id sur P(X).)
# @livre Ch.III §3.5 Demo.12 | E III.29 L.25-26 | PDF p.132
