...
# ═══════════════════════════════════════════════════════════════════════════════
# (palier IMAGE de l'injection produit — démonstration de la Prop.14, volet produit.)
...
# ═══════════════════════════════════════════════════════════════════════════════
# (Prop.14, volet PRODUIT, cas binaire : la forme famille (P sur I) n'est pas formalisée.)
