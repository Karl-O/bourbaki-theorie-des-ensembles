...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import Terme, var, egal, et, impl, inclus
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.definitions_cardinaux.ensembles_cardinaux import (equipotent, cardinal, inf_egal_card)
...
# ═══════════════════════════════════════════════════════════════════════════════
# (brique de transport (X<=Y) => (Card X <= Card Y), utilisée par la démo du Cor.2.)
...
#      (𝓕(C;A) ≤ 𝓕(C;B)) ⇒ (a^c ≤ b^c)
# ═══════════════════════════════════════════════════════════════════════════════
# (Cor.2 §3.6, volet BASE (a<=a' => a^b <= a'^b), forme CONDITIONNELLE — la version
#  inconditionnelle est close dans ensembles_exposant_monotone_incond.)
...
#      (𝓕(C;A) ≤ 𝓕(D;A)) ⇒ (a^c ≤ a^d)
# ═══════════════════════════════════════════════════════════════════════════════
# (Cor.2 §3.6, volet EXPOSANT (b<=b', a'>0 => a'^b <= a'^b'), forme CONDITIONNELLE.)
# @livre Ch.III §3.6 Cor.2 | E III.30 L.16-17 | PDF p.133
