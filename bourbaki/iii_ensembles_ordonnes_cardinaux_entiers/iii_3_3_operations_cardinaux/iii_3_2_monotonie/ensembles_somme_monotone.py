...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (Terme, var, egal, et, appartient, existe, inclus, subst_t)
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_3_somme import ensembles_somme_equipotence as S
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_3_produit.ensembles_produit_equipotence import (_valeur_dans_image,
                               _valeur_cy)
...
# ═══════════════════════════════════════════════════════════════════════════════
# (palier IMAGE de l'injection somme — démonstration de la Prop.14, volet somme.)
# @livre Ch.III §3.6 Demo.14 | E III.30 L.7-11 | PDF p.133
...
# ═══════════════════════════════════════════════════════════════════════════════
# (Prop.14, volet SOMME, cas binaire : la forme famille (Σ sur I) n'est pas formalisée.)
# (E III.29 L.28 : titre « 6. Relation d'ordre et opérations entre cardinaux » ;
#  E III.30 L.1-3 : petit texte « on ne peut pas définir une différence a−b » —
#  prose, rien à formaliser.)
# @livre Ch.III §3.6 Rem.- | E III.29 L.28-28 | PDF p.132
# @livre Ch.III §3.6 Rem.- | E III.30 L.1-3 | PDF p.133
# @livre Ch.III §3.6 Prop.14 | E III.30 L.4-6 | PDF p.133
...
# ═══════════════════════════════════════════════════════════════════════════════
# (cas particulier de la Prop.14 : B:=N1:={vide} — « le successeur est croissant ».)
# @livre Ch.III §3.6 Prop.14 | E III.30 L.4-6 | PDF p.133
...
# (Prop.14 instanciée aux termes Card A, Card B : a <= b => a+1 <= b+1.)
# @livre Ch.III §3.6 Prop.14 | E III.30 L.4-6 | PDF p.133
