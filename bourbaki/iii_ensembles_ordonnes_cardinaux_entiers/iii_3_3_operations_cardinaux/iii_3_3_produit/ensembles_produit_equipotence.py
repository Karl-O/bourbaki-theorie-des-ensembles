...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.cantor.ensembles_cantor import (graphe_terme_couple_dans, graphe_terme_domaine,
                              graphe_terme_valeur)
...
from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege import syllogisme as _syll
...
# (bien-définition du produit binaire ab : « la somme et le produit … ne dépendent
#  que de a et b » — prose définissant a+b et ab en E III.27 L.3-9.)
# (Prop. 4, cas binaire produit : le cardinal de l'ensemble produit est le produit
#  cardinal — l'invariance Eq(X,X₁)∧Eq(Y,Y₁)⇒Eq(X×Y,X₁×Y₁) en est la forme du projet.)
