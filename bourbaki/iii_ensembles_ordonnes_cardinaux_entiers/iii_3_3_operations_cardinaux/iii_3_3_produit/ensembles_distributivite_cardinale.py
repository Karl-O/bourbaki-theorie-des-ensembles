...
# (Prop. 5 c) cas binaire : distributivité du produit par rapport à la somme ;
#  la démo du livre pour c) déborde en E III.27 L.1-2.)
# @livre Ch.III §3.3 Prop.5 | E III.26 L.20-23 | PDF p.129
# @livre Ch.III §3.3 Demo.5 | E III.27 L.1-2 | PDF p.130
