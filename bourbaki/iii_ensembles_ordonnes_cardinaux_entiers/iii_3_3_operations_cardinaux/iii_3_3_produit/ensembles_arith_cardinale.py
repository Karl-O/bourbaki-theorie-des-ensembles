...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (Terme, var, egal, et, impl, appartient, existe,
                     subst_t, subst_f)
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_3_produit.ensembles_produit_commute import eq_produit_commute
...
from bourbaki.i_description_mathematique_formelle.i_4_theories_quantifiees.i_4_3_tactiques_abrege_quantif import (existe_elimination, alpha_existe,
                                      congruence_existe)
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.definitions_cardinaux.ensembles_cardinaux import equipotent, est_bijection_de
...
# (les trois Rem : titre « 3. Opérations sur les cardinaux » + convention « produit »/
#  « somme » et notation ∏ au lieu de P — prose, rien à formaliser.)
# @livre Ch.III §3.3 Rem.- | E III.25 L.31-31 | PDF p.128
# @livre Ch.III §3.3 Rem.- | E III.25 L.35-35 | PDF p.128
# @livre Ch.III §3.3 Rem.- | E III.26 L.1-2 | PDF p.129
# @livre Ch.III §3.3 Def.3 | E III.25 L.32-34 | PDF p.128
...
# @livre Ch.III §3.3 Cor.- | E III.27 L.10-11 | PDF p.130
...
def reassoc_graphe_injective(x="X", y="Y", z="Z"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_3_produit.ensembles_produit_commute import (_membre_produit_egal_couple_ab,
...
def reassoc_graphe_image(x="X", y="Y", z="Z"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_3_produit.ensembles_produit_commute import (_membre_produit_pr1_ab,
...
# (Prop. 5 b) cas binaire : associativité du produit — partition {{1,2},{3}} de I.)
