...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (Terme, var, egal, et, ou, appartient, existe,
                     subst_t, subst_f)
...
def proj_graphe_image(a="A"):
    ...
    from bourbaki.ii_theorie_des_ensembles.ii_1_relations_collectivisantes.ensembles_theoremes import egalite_par_extension as _ext
    vA = _t(a)
    sing = E.singleton(E.VIDE)
