...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (Terme, var, egal, et, ou, non, appartient, existe,
                     subst_t, subst_f)
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_3_produit.ensembles_produit_commute import (_projection_premiere_ab, _projection_seconde_ab)
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.equipotence.ensembles_vide_singleton import vide_distinct_singleton
...
def _selecteur_valeur(f, g, w, gauche=True):
    ...
    from bourbaki.ii_theorie_des_ensembles.ii_2_couples.ii_2_1_definition_couples.ensembles_projections import tau_egal
...
def _ou_commute_gd(gd, cond2):
    ...
    from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import comm_ou
...
def somme_graphe_injective(f="F", g="G", a="A", b="B"):
    ...
    from bourbaki.ii_theorie_des_ensembles.ii_4_reunion_intersection_famille.ii_4_recollement_somme.ensembles_somme_disjointe import membre_somme_caracterise
    ...
    from bourbaki.i_description_mathematique_formelle.i_4_theories_quantifiees.i_4_3_tactiques_abrege_quantif import alpha_existe as _ax
...
def _somme_image_backward(f, g, a, b, a1, b1, vz, K, AB, A1B1, T,
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_3_produit.ensembles_produit_equipotence import _antecedent_image, _valeur_cy
    from bourbaki.ii_theorie_des_ensembles.ii_4_reunion_intersection_famille.ii_4_recollement_somme.ensembles_somme_disjointe import (membre_somme_caracterise, _ou_congruence,
                                           injection_gauche_dans_somme,
                                           injection_droite_dans_somme)
    from bourbaki.ii_theorie_des_ensembles.ii_3_correspondances.ii_3_4_fonctions.ensembles_fonctions import valeur_caracterisation
    from bourbaki.i_description_mathematique_formelle.i_4_theories_quantifiees.i_4_3_tactiques_abrege_quantif import alpha_existe as _ax
...
def _val_cy_eq(fF, t1, t2, eq_c):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_3_produit.ensembles_produit_equipotence import _valeur_cy
...
def somme_graphe_image(f="F", g="G", a="A", b="B", a1="A1", b1="B1"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_3_produit.ensembles_produit_equipotence import _valeur_dans_image, _antecedent_image
    from bourbaki.ii_theorie_des_ensembles.ii_4_reunion_intersection_famille.ii_4_recollement_somme.ensembles_somme_disjointe import membre_somme_caracterise, _ou_congruence
    from bourbaki.ii_theorie_des_ensembles.ii_3_correspondances.ii_3_4_fonctions.ensembles_fonctions import valeur_caracterisation
    from bourbaki.i_description_mathematique_formelle.i_4_theories_quantifiees.i_4_3_tactiques_abrege_quantif import alpha_existe as _ax
    vF, vG = _t(f), _t(g)
...
def _renomme_injective(c3):
    ...
    from bourbaki.i_description_mathematique_formelle.i_4_theories_quantifiees.i_4_3_tactiques_abrege_quantif import alpha_pour_tout, congruence_pour_tout
...
# (bien-définition de la somme binaire a+b : prose définissant a+b et ab.)
# (Prop. 4, cas binaire somme : le cardinal de l'ensemble somme est la somme
#  cardinale — l'invariance Eq(A,A₁)∧Eq(B,B₁)⇒Eq(A⊔B,A₁⊔B₁) en est la forme du projet.)
# @livre Ch.III §3.3 Prop.4 | E III.26 L.3-5 | PDF p.129
# @livre Ch.III §3.3 Demo.4 | E III.26 L.6-8 | PDF p.129
# @livre Ch.III §3.3 Def.- | E III.27 L.3-9 | PDF p.130
def eq_somme_invariant(f="F", g="G", a="A", b="B", a1="A1", b1="B1"):
    ...
    from bourbaki.i_description_mathematique_formelle.i_4_theories_quantifiees.i_4_3_tactiques_abrege_quantif import alpha_existe as _alpha
    vF, vG = _t(f), _t(g)
    va, vb, va1, vb1 = _t(a), _t(b), _t(a1), _t(b1)
    AB = somme_disjointe(va, vb)
    A1B1 = somme_disjointe(va1, vb1)
