...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_3_somme.ensembles_somme_equipotence import _neg_un_egal_zero
...
def _ren(ex_node, cible):
    ...
    from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import equivalence_avant as _eqav
    src = ex_node.lieur
    if src == cible:
...
# (Prop. 5 b) cas binaire : associativité de la somme — partition {{1,2},{3}} de I.)
# @livre Ch.III §3.3 Prop.5 | E III.26 L.16-19 | PDF p.129
# @livre Ch.III §3.3 Demo.5 | E III.26 L.28-32 | PDF p.129
