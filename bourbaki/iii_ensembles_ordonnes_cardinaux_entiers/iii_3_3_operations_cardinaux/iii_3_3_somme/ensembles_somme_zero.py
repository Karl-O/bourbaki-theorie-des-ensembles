...
def neutre_graphe_image(b="B"):
    ...
    def back_droite():
        ...
        from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import instancie as _inst
...
# (E III.27 L.14 : titre « 4. Propriétés des cardinaux 0 et 1 » — prose, rien à
#  formaliser.  Cor.1 de la Prop.6 : a + 0 = a.1 = a, volet somme.)
# @livre Ch.III §3.4 Rem.- | E III.27 L.14-14 | PDF p.130
# @livre Ch.III §3.4 Cor.1 | E III.27 L.24-24 | PDF p.130
