...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_3_somme.ensembles_somme_equipotence import (_garde_disjonction, _neg_un_egal_zero,
                                         _ou_commute_gd)
...
# (support ensembliste de la formule (1) a+b = b+a : Eq(A⊔B, B⊔A) par flip du marqueur.
#  Prop. 5 a) cas binaire : invariance de la somme par bijection des indices.)
