...
`bourbaki.ii_theorie_des_ensembles.ii_6_relations_equivalence.ii_6_5_decomposition.ensembles_decomposition_quotient`
...
CONVENTION DE PARAMÉTRAGE — identique au reste de `bourbaki.iv_structures` (cf.
...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import var, et, impl, appartient, app
...
from bourbaki.ii_theorie_des_ensembles.ii_6_relations_equivalence.ii_6_5_decomposition.ensembles_decomposition_quotient import (
