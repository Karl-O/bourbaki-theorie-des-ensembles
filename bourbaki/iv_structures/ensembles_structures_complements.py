...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (var, app, egal, et, impl, equiv, existe,
...
from bourbaki.iv_structures.ensembles_universel_applications import (
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.IV §3.2 Def.- | E IV.23 L.37-38 | PDF p.226
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.IV §3.2 Def.CU_I | E IV.23 L.32-33 | PDF p.226
...
# @livre Ch.IV §3.2 Def.CU_II | E IV.23 L.34-36 | PDF p.226
...
# @livre Ch.IV §3.2 Def.CU_III | E IV.24 L.1-4 | PDF p.227
...
# @livre Ch.IV §3.2 Def.CU_III | E IV.23 L.39-39 | PDF p.226
# @livre Ch.IV §3.2 Def.CU_III | E IV.24 L.1-4 | PDF p.227
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.IV §3.2 Crit.CST22 | E IV.24 L.5-6 | PDF p.227
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.IV §3.1 Cor.- | E IV.23 L.5-15 | PDF p.226
