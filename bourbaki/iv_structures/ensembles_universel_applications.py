...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (var, egal, et, impl, equiv, existe,
...
# ── axiomes (QM_I), (QM_II) de la donnée α ────────────────────────────────────
# @livre Ch.IV §3.1 Ax.QM_I | E IV.22 L.32-32 | PDF p.225
...
# @livre Ch.IV §3.1 Ax.QM_II | E IV.22 L.33-35 | PDF p.225
...
#  α-application
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.IV §3.1 Def.- | E IV.22 L.36-37 | PDF p.225
...
# @livre Ch.IV §3.1 Def.AU_I' | E IV.23 L.19-20 | PDF p.226
...
# @livre Ch.IV §3.1 Def.AU_II' | E IV.23 L.21-22 | PDF p.226
...
# @livre Ch.IV §3.1 Def.- | E IV.22 L.38-39 | PDF p.225
...
# @livre Ch.IV §3.1 Def.- | E IV.23 L.3-4 | PDF p.226
...
# @livre Ch.IV §3.1 Demo.- | E IV.23 L.23-27 | PDF p.226
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.IV §3.2 Crit.CST23 | E IV.24 L.39-40 | PDF p.227
# @livre Ch.IV §3.2 Crit.CST23 | E IV.25 L.1-2 | PDF p.228
# @livre Ch.IV §3.2 Demo.- | E IV.25 L.3-3 | PDF p.228
# @livre Ch.IV §3.2 Rem.- | E IV.25 L.4-8 | PDF p.228
# (Rem : terminologie « les α-applications séparent les éléments de E » + prolongement
#  unique en un morphisme de F_E — prose calée ici, la notion formalisée est ci-dessous.)
...
#  Σ-ENSEMBLE LIBRE ENGENDRÉ par E (cas algébrique, α = 𝓕(E ; x))
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.IV §3.3 Ex.I | E IV.25 L.12-24 | PDF p.228
# @livre Ch.IV §3.3 Rem.- | E IV.25 L.9-11 | PDF p.228
# (Rem : titre « 3. Exemples d'applications universelles » + intro — prose, rien à formaliser.)
def alpha_libre(e):
...
# @livre Ch.IV §3.3 Ex.II | E IV.25 L.25-35 | PDF p.228
...
# @livre Ch.IV §3.3 Ex.III | E IV.25 L.36-39 | PDF p.228
# @livre Ch.IV §3.3 Ex.III | E IV.26 L.1-5 | PDF p.229
...
# @livre Ch.IV §3.3 Ex.VI | E IV.26 L.20-30 | PDF p.229
