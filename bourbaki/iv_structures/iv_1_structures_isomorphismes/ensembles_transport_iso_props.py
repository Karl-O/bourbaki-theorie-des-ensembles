...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import var, egal, et, subst_f
...
#  1.  RÉCIPROQUE D'UN ISOMORPHISME D'ESPÈCE EST UN ISOMORPHISME  (IV.1.5)
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.IV §1.5 Prop.- | E IV.6 L.13-18 | PDF p.209
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.IV §1.5 Prop.- | E IV.6 L.19-21 | PDF p.209
...
# ════════════════════════════════════════════════════════════════════════════
# @livre Ch.IV §1.5 Prop.- | E IV.6 L.28-32 | PDF p.209
...
# @livre Ch.IV §1.2 Crit.CST1 | E IV.2 L.30-32 | PDF p.205
