...
from bourbaki.ii_theorie_des_ensembles.ii_5_produit_famille.ii_5_6_7_algebre_produit.ensembles_cor_prop8_deux_familles_ii5 import (
...
# @livre Ch.R §4 Prop.- | E.R.18 item 3 ((37) distributivité (⋃X_ι)∩(⋃Y_κ)=⋃(X_ι∩Y_κ)) | PDF p.321
