...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_5_exposant.prop10_currying.ensembles_prop10_inj_curry import inf_egal_curry
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_3_operations_cardinaux.iii_3_5_exposant.prop10_currying.ensembles_prop10_inj_uncurry import inf_egal_uncurry
...
# @livre Ch.R §4 Prop.- | E.R.22 item 14 (bijection canonique E^(F×G) ≅ (E^F)^G) | PDF p.325
