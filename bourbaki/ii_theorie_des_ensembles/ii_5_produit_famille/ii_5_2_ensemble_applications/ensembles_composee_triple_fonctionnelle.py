...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import var, et, Terme
...
# @livre Ch.R §2 Prop.- | E.R.10 item 11 (composée h∘g∘f de trois applications) | PDF p.313
