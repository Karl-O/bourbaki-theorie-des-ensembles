...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import Terme, var, egal, et, ou, appartient, impl
...
from bourbaki.ii_theorie_des_ensembles.ii_1_relations_collectivisantes.ensembles_theoremes import (_instance_paire, appartient_singleton,
...
# @livre Ch.R §3 Prop.- | E.R.11 item 1 ((x,y)=(x',y') équivalente à « x=x' et y=y' ») | PDF p.314
