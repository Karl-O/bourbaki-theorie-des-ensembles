...
# @livre Ch.R §5 Def.- | E.R.23 item 3 (relation f(x)=f(y) associée à une application f) | PDF p.326
...
# @livre Ch.R §5 Prop.- | E.R.23 item 3 (f(x)=f(y) est une relation d'équivalence dans E) | PDF p.326
...
# @livre Ch.II §6.5 Def.- | E II.44 L.23-32 | PDF p.95
# @livre Ch.R §5 Prop.- | E.R.23 item 3 (décomposition canonique f = injection∘bijection∘surjection) | PDF p.326
...
# @livre Ch.R §5 Def.- | E.R.25 item 9 (relation quotient T/R, quotient de quotient) | PDF p.328
...
# @livre Ch.R §5 Prop.- | E.R.25 item 9 (T compatible avec R : passage au quotient en x et y) | PDF p.328
