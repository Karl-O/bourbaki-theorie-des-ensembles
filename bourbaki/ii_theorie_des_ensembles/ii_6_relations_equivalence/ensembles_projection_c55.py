...
`ii_6_relations_equivalence.ensembles_quotient_props_graphe` :
...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import Terme, var, egal, equiv, appartient
from bourbaki.ii_theorie_des_ensembles.ii_1_relations_collectivisantes import ensembles_abrege as E
from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import (
    equivalence_symetrie, equivalence_transitivite)
from bourbaki.ii_theorie_des_ensembles.ii_6_relations_equivalence.ensembles_quotient_props_graphe import (
