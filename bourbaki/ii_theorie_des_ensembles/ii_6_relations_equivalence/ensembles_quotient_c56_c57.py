...
# @livre Ch.R §5 Prop.- | E.R.24 item 7 (relation déduite de P par passage au quotient) | PDF p.327
...
# @livre Ch.R §5 Prop.- | E.R.24 item 7 (φ constante sur chaque classe → φ' de E/R dans F, φ=φ'∘f) | PDF p.327
