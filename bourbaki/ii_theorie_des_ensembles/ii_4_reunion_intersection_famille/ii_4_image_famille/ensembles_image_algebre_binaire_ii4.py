...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_5_calcul_entiers.entiers_cardinaux.ensembles_produit_union_carre import existe_ou
...
# @livre Ch.R §2 Def.- | E.R.8 item 6 (image réciproque f⁻¹(Y) de Y par f) | PDF p.311
...
# @livre Ch.R §2 Prop.- | E.R.8 item 5c ((11) f(X∪Y)=f(X)∪f(Y)) | PDF p.311
# @livre Ch.R §3 Prop.- | E.R.14 item 8c ((28) K(X∪Y)=K(X)∪K(Y)) | PDF p.317
...
# ════════════════════════════════════════════════════════════════════════════
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import pourtout, subst_f
from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import syllogisme
...
# @livre Ch.R §2 Prop.- | E.R.8 item 7b ((14) f⁻¹(X∩Y)=f⁻¹(X)∩f⁻¹(Y)) | PDF p.311
...
# @livre Ch.R §2 Prop.- | E.R.8 item 5c ((12) f(X∩Y)⊂f(X)∩f(Y)) | PDF p.311
# @livre Ch.R §3 Prop.- | E.R.14 item 8c ((29) K(X∩Y)⊂K(X)∩K(Y)) | PDF p.317
...
# @livre Ch.R §2 Prop.- | E.R.8 item 7b ((15) f⁻¹(∁X)=∁f⁻¹(X), version différence ∖) | PDF p.311
