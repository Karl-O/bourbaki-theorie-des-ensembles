...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import var, egal, et, ou, appartient, existe, Terme
...
# @livre Ch.R §2 Prop.- | E.R.8 item 7b ((13) f⁻¹(X∪Y)=f⁻¹(X)∪f⁻¹(Y)) | PDF p.311
