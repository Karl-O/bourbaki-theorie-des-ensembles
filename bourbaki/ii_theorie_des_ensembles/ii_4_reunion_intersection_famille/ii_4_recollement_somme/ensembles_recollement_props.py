...
def recollement_binaire_unicite(p="P", q="Q"):
    ...
    from bourbaki.ii_theorie_des_ensembles.ii_3_correspondances.ii_3_5_restrictions_prolongements.ensembles_restrictions import coincidence_meme_graphe
...
def bijection_canonique_reunion_somme(a="A", b="B"):
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.recollement.ensembles_restriction_somme import recollement
    va, vb = _t(a), _t(b)
