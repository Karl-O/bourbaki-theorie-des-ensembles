...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (Terme, var, egal, et, ou, non, impl, appartient, existe, subst_f)
...
from bourbaki.i_description_mathematique_formelle.i_5_theories_egalitaires.i_5_2_tactiques_abrege_egalite import composer_egalites, congruence_terme
...
# @livre Ch.R §4 Def.- | E.R.18 item 5 (somme : cas de deux ensembles A⊔B) | PDF p.321
