...
-----------------------------------------------------
La clause de rétraction est_retraction(F⁻¹,F,A) est, par définition (E II.18, Déf. 11),
...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import var, appartient, egal, impl, Terme
...
# @livre Ch.R §2 Prop.- | E.R.10 item 12 (g∘f = Id_E pour g réciproque de f, niveau valeurs) | PDF p.313
