...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import var, egal, et, appartient, existe, subst_f, Terme
...
# @livre Ch.R §3 Prop.- | E.R.13 item 4 ((X×Y)⁻¹ = Y×X) | PDF p.316
def reciproque_produit(x="X", y="Y"):
    ...
    from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import (equivalence_symetrie, comm_et, assoc_et,
