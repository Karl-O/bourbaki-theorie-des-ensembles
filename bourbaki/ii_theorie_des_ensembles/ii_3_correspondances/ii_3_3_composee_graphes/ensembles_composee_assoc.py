...
from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import (equivalence_transitivite, equivalence_avant,
                               antecedent_consequent, et_congruence_droite,
                               et_congruence_gauche, assoc_et, instancie)
from bourbaki.i_description_mathematique_formelle.i_4_theories_quantifiees.i_4_3_tactiques_abrege_quantif import (congruence_existe, et_existe_droite,
                                      et_existe_gauche, existe_commute, alpha_existe)
from bourbaki.ii_theorie_des_ensembles.ii_3_correspondances.ii_3_3_composee_graphes.ensembles_composee import couple_composee, _inst_composee
...
# @livre Ch.R §2 Prop.- | E.R.10 item 11 (h∘(g∘f)=(h∘g)∘f) | PDF p.313
# @livre Ch.R §3 Prop.- | E.R.15 item 10 (C∘(B∘A)=(C∘B)∘A) | PDF p.318
