...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import Terme, var, egal, et, impl, appartient, pourtout
...
# @livre Ch.R §3 Def.- | E.R.13 item 5 (partie C de E×F fonctionnelle : graphe d'une fonction) | PDF p.316
...
# @livre Ch.R §2 Def.- | E.R.7 item 3 (application identique Id_E) | PDF p.310
