...
from bourbaki.ii_theorie_des_ensembles.ii_3_correspondances.ii_3_1_graphes_correspondances.ensembles_diagonale_couple import (
...
# @livre Ch.R §3 Prop.- | E.R.15 item 11 ((32) A∘Δ=A) | PDF p.318
...
# @livre Ch.II §3.3 Def.8 | E II.13 L.25-26 | PDF p.64
# @livre Ch.R §3 Prop.- | E.R.15 item 11 ((32) Δ'∘A=A) | PDF p.318
