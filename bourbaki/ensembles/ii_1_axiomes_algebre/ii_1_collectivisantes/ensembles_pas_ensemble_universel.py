...
from bourbaki.logique.i_1_termes_relations.formule import (var, tau, app, non, et, equiv, appartient,
...
from bourbaki.ensembles.ii_1_axiomes_algebre.ensembles_theoremes import non_collectivisante_appartenance_propre
