...
from bourbaki.logique.i_1_termes_relations.formule import Terme, var, appartient, et, ou, non, impl, inclus, egal
...
from bourbaki.ensembles.ii_1_axiomes_algebre.ensembles_difference_identites import (
