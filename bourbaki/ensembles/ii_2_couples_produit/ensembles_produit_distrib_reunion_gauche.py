...
from bourbaki.logique.i_1_termes_relations.formule import Terme, var, appartient, et, ou
...
def couple_dans_produit_distrib_reunion_premier_facteur(
    ...
    from bourbaki.logique.i_2_criteres_C.tactiques.tactiques_abrege2 import et_congruence_gauche
