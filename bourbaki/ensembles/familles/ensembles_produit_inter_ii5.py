...
from bourbaki.ensembles.ensembles_algebre_booleenne import _instance_inter
from bourbaki.ensembles.familles.ensembles_produit_props2 import _congruence_appartient
