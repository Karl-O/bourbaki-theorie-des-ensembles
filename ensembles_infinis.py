...
from formule import (Terme, var, app, tau, egal, et, non, impl, equiv, ou,
                     existe, pourtout, appartient, inclus)
import noyau_abrege as N
import ensembles_abrege as E
from ensembles_cardinaux import cardinal, equipotent, inf_egal_card
from ensembles_entiers import est_fini, est_fini_ensemble, est_entier
