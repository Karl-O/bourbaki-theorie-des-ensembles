...
from formule import (Terme, var, app, egal, et, non, impl, existe, pourtout, equiv,
                     inclus, appartient)
import ensembles_abrege as E
from ensembles_cardinaux import (cardinal, est_cardinal, CARD_VIDE,
                                 inf_egal_card, inf_strict_card)
from ensembles_somme_disjointe import somme_cardinale_binaire
