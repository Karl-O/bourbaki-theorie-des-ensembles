...
from lecture import DEFAUT, est_relation
import noyau
from tactiques import antecedent_consequent
from tactiques_prop import contraposition, double_negation_intro, double_negation_elim
from chercheur import vocabulaire, _est_implication
