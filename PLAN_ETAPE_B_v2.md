...
## [x] Proposition 10 — élément maximal d'un ensemble ordonné filtrant à droite = plus grand élément  (faible/facile)
...
## [x] segment_de_segment_est_segment (transitivité des segments, clôture Déf. 2)  (faible/facile)
...
## [x] theoreme1_e_surjective_valeur  (faible/moyen)
...
## [x] associativite_reunion_famille — Proposition 2 (réunion), partie INCONDITIONNELLE  (faible/moyen)
...
## [x] Proposition 1 (réciproque) : a),b),c) ⇒ Γ équivalence dans X — symétrie & transitivité du graphe  (faible/moyen)
...
## [x] Saturé Ã = p⁻¹⟨p⟨A⟩⟩ : Ã est saturée pour R (clôture par R)  (faible/difficile)
...
## [x] Proposition 13 — l'intersection de deux intervalles fermés est un intervalle  (moyen/moyen)
