...
from formule import var, egal, et, appartient, existe, pourtout
...
from tactiques_abrege_egalite import symetrie as eg_symetrie, composer_egalites
...
def diagonale_image(x="X"):
    ...
    from tactiques_abrege2 import et_congruence_droite
