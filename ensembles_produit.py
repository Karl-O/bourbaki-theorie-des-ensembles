...
from formule import var, egal, et, ou, non, impl, appartient, existe, inclus, subst_f
...
from tactiques_abrege_quantif import (monotonie_existe, existe_elimination,
                                      alpha_pour_tout, alpha_existe)
from tactiques_abrege_egalite import composer_egalites, congruence_terme
from ensembles_projections import projection_premiere, projection_seconde
from ensembles_vide import vide_ssi_sans_element, non_vide_ssi_element
...
def couple_dans_produit_ssi(u="u", v="v", a="A", b="B"):
    ...
    from tactiques_abrege_egalite import congruence_terme
