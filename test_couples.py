...
from formule import var, egal, et, impl, equiv, app, tau, existe, afficher_f
from ensembles_abrege import couple, pr1, pr2, paire, singleton
from ensembles_theoremes import couple_egal_si_composantes
from ensembles_couples import (singleton_membre, singleton_injectif,
...
from tactiques_abrege_egalite import (symetrie, transitivite, composer_egalites,
                                      congruence_terme)
...
def test_singleton_membre():
    from formule import appartient
    a, c = var("a"), var("c")
