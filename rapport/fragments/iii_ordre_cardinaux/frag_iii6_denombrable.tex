...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\linewidth]{figures/chronologie_l2.png}
  \caption{Temps de certification noyau des briques du Lemme 2 (pile W) :
  6,4~h de vérification LCF cumulée, dominée par les récurrences C61 et
  l'assemblage Cantor--Bernstein. Script reproductible
  \texttt{figures/gen\_chronologie\_l2.py}.}
\end{figure}
