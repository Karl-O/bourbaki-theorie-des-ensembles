...
from assemblage import disjonction, negation
from propositions import A, B, C, D, E, SIG_PROP
from lecture import est_relation  # noqa: F401  (cohérence d'API)
import noyau
from tactiques import antecedent_consequent
from chercheur import _est_implication
from prouveur_goal import _rels, _instances, _macros, prouver
from encodeur import traits_paire_seq, traits_alignement
