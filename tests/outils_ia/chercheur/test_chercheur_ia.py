...
from bourbaki.i_description_mathematique_formelle.assemblage import implication, disjonction
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_propositions import A, B, C, D, SIG_PROP
