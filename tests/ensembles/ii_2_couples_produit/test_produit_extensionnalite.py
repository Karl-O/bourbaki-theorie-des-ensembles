...
import bourbaki.ensembles.ii_2_couples_produit.ensembles_produit_extensionnalite as M
...
def test_formule_22_hypotheses_ambiants_honnetes():
    ...
    t = M.produit_distrib_reunion_premier_facteur_ensembliste()
    from bourbaki.logique.i_1_termes_relations.formule import inclus, et
