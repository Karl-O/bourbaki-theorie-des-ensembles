...
Module testé :
bourbaki.ensembles.fonctions.ii_3_7_composee_fonctions.ensembles_reciproque_identite.
...
from bourbaki.ensembles.fonctions.ii_3_7_composee_fonctions import (
