...
from bourbaki.logique.i_1_termes_relations.formule import var, egal, et, non, appartient, equiv
...
from bourbaki.logique.i_2_criteres_C.tactiques.tactiques_abrege2 import demorgan_ou, demorgan_et, et_ou_distrib
