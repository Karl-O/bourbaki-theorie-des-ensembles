...
from bourbaki.i_description_mathematique_formelle.assemblage import (Assemblage, negation, implication, equivalence, egalite,
                        existe, pour_tout)
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_propositions import SIG_PROP
from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques import a_implique_a
from bourbaki.i_description_mathematique_formelle.i_2_theoremes.criteres import criteres_C as K
from bourbaki.i_description_mathematique_formelle.i_4_theories_quantifiees import i_4_3_congruence_quantif as Q
