...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations import outil_formule as F
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (var, egal, appartient, inclus, non, ou, et, impl,
...
def test_affichage():
    ...
    from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import impl, var as v
    assert afficher_f(impl(egal(v("a"), v("b")), egal(v("c"), v("d")))) == "((a = b) ⇒ (c = d))"
    assert afficher_f(A1).startswith("(∀x) (∀y)")


def test_alpha_equivalence():
    from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import alpha_egal, existe, appartient, var as v
...
def test_pont_developper_petit_cas():
    ...
    from bourbaki.i_description_mathematique_formelle.assemblage import egalite, Assemblage
