...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_propositions import A, B, SIG_PROP
from bourbaki.i_description_mathematique_formelle.i_4_theories_quantifiees import i_4_3_criteres_quantif2 as Q2
