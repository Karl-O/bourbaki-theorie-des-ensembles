...
# ════════════════════════════════════════════════════════════════════════════
#  🎯 LE FIX — la technique de la VARIABLE FRAÎCHE résout la collision τ.
#     Le pont se CONSTRUIT à la variable fraîche, LÈVE au témoin τ.
# ════════════════════════════════════════════════════════════════════════════
...
def test_pont_leve_au_temoin_tau():
    ...
    with pytest.raises(ValueError, match="modus ponens"):
        ADJB.iso_hplus_pour_R_majorants_discharges("E", "R", "F", "Rp", a_star, b_star)
