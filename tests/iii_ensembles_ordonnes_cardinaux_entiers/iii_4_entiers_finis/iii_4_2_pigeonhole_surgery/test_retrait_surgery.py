"""Tests miroir de iii_4_entiers_finis/iii_4_2_pigeonhole_surgery/ensembles_retrait_surgery.py.
...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (var, et, non, impl, inclus, appartient,
                                       existe, egal)
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_2_pigeonhole_surgery.ensembles_retrait_point import retrait_surgery_hyp
...
def test_retrait_point_hyp_mod_general_clos():
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_recurrence_c61_existence_n.ensembles_cardinal_pas_entre import retrait_point_hyp
