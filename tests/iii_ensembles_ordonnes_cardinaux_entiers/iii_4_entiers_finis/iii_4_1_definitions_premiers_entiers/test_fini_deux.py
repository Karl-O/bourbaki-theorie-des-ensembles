...
"""
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_1_definitions_premiers_entiers.ensembles_fini_deux import (card_un_egale_un,
                                                  card_deux_egale_deux,
                                                  deux_distinct_successeur_deux,
                                                  deux_est_un_cardinal, fini_deux)
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_1_definitions_premiers_entiers.ensembles_entiers import UN, DEUX, successeur, est_fini, est_cardinal
