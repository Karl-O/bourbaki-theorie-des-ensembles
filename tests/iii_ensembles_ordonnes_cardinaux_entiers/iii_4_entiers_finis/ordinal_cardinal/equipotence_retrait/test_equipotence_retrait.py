...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import var, et, appartient, impl
...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.definitions_cardinaux.ensembles_cardinaux import est_bijection_de, equipotent, est_cardinal
...
def test_gen_interchangeable_avec_surgery():
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_2_pigeonhole_surgery.ensembles_retrait_point import _S, _STAR
...
def test_cardinal_pas_entre_inconditionnel():
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_4_entiers_finis.iii_4_2_pigeonhole_surgery.ensembles_retrait_surgery import cardinal_pas_entre_mod_general
