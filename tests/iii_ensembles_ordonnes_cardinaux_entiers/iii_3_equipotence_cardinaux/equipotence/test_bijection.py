...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.equipotence.ensembles_bijection import reciproque_fonctionnelle
...
def test_reciproque_domaine():
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.equipotence.ensembles_bijection import reciproque_domaine
...
def test_image_reciproque():
    from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import egal
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.equipotence.ensembles_bijection import image_reciproque
    vF, vX, vY = var("F"), var("X"), var("Y")
...
def test_reciproque_injective():
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.equipotence.ensembles_bijection import reciproque_injective
    vF, vX, vY = var("F"), var("X"), var("Y")
...
def test_reciproque_est_application():
    from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import impl, et
    ...
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.equipotence.ensembles_bijection import reciproque_est_application
    vF, vX, vY = var("F"), var("X"), var("Y")
...
def test_composee_image():
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.equipotence.ensembles_bijection import composee_image
...
def test_composee_domaine():
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.equipotence.ensembles_bijection import composee_domaine
...
def test_composee_injective():
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.equipotence.ensembles_bijection import composee_injective
    vG, vF, vX, vY = var("G"), var("F"), var("X"), var("Y")
...
def test_equipotence_transitive():
    from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import et, impl
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_3_equipotence_cardinaux.definitions_cardinaux.ensembles_cardinaux import equipotent
