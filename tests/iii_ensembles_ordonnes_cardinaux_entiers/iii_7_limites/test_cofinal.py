...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_7_limites import ensembles_cofinal as C
...
def test_systeme_projectif_filtrant_forme():
    ...
    leq = _leq()
    f = C.est_systeme_projectif_filtrant("E", "f", leq, "I")
    attendu = et(E.est_filtrant_droite(leq, var("I"), "x", "y", "z"),
                 L.est_systeme_projectif(var("E"), var("f"), leq, var("I"),
                                         "a", "b", "g", "x", "zt"))
    assert f == attendu
...
def test_systeme_projectif_filtrant_decompositions():
    ...
    assert th_sys.conclusion == L.est_systeme_projectif(
        var("E"), var("f"), leq, var("I"), "a", "b", "g", "x", "zt")
