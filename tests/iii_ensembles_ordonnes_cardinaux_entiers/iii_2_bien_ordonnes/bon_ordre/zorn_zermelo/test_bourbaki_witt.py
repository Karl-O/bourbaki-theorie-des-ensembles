...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_1_relations_ordre.ordre_treillis import ensembles_ordre_relation as O
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.bon_ordre.zorn_zermelo.ensembles_zorn import chaine, zorn
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.bon_ordre.zorn_zermelo import ensembles_bourbaki_witt as BW
...
def test_chaine_complet_definition():
    ...
    corps = impl(chaine(G, Es, C),
                 __import__("bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule", fromlist=["existe"]).existe(
