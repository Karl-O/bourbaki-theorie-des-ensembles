...
"""
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import var, appartient, equiv, inclus
from bourbaki.ii_theorie_des_ensembles.ii_1_relations_collectivisantes import ensembles_abrege as E
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.bon_ordre.zorn_zermelo import ensembles_zorn_theoreme as Z
...
def test_vide_est_chaine():
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.bon_ordre.zorn_zermelo.ensembles_zorn import chaine
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_1_relations_ordre.ordre_treillis.ensembles_ordre_relation import antisymetrie, transitivite_rel
    t = Z.vide_est_chaine()
...
def test_vide_plus_petit():
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_1_relations_ordre.ordre_treillis.ensembles_ordre_relation import plus_petit_element
    t = Z.vide_plus_petit()
...
def test_Union_borne_sup():
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_1_relations_ordre.ordre_treillis.ensembles_ordre_relation import borne_superieure
    Dd2 = var("D")
    t = Z.Union_borne_sup()
...
def test_Gamma_chaine_complet():
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.bon_ordre.zorn_zermelo.ensembles_bourbaki_witt import chaine_complet
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_1_relations_ordre.ordre_treillis.ensembles_ordre_relation import antisymetrie, transitivite_rel
...
def test_f_application_dans():
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.bon_ordre.zorn_zermelo.ensembles_bourbaki_witt import application_dans
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.bon_ordre.zorn_zermelo.ensembles_zorn import est_inductif
...
def test_f_inflationnaire_strict():
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.bon_ordre.zorn_zermelo.ensembles_bourbaki_witt_chaine import inflationnaire_strict
...
def test_zorn_theoreme_conclusion_est_maximal():
    from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import existe, impl
