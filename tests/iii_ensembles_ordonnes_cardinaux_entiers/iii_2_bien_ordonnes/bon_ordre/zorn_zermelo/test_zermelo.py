...
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_1_relations_ordre.ordre_treillis.ensembles_ordre_relation import est_ordre, transitivite_rel
from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.bon_ordre.zorn_zermelo import ensembles_zermelo as Z
...
def test_Union_transitif():
    from bourbaki.ii_theorie_des_ensembles.ii_1_relations_collectivisantes.ensembles_abrege import ordre_transitif
...
def test_Union_bop_match():
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_2_bien_ordonnes.bon_ordre.zorn_zermelo.ensembles_zermelo import bon_ordre_partiel
    th = Z.Union_bop("X", "D")
    Ut = Z.Union(X, var("D"))
...
def test_Union_majorant():
    from bourbaki.iii_ensembles_ordonnes_cardinaux_entiers.iii_1_relations_ordre.ordre_treillis.ensembles_ordre_relation import majorant
...
def test_Ext_seg_initial():
    ...
    from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import var, non, appartient
