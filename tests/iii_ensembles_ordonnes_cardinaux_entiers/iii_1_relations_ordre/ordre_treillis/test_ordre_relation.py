...
"""
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import var, egal, et, ou, impl, appartient, inclus
...
def test_definitions_ordre_construisent():
    ...
    from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import var as _v, pourtout, impl as _impl, et as _et
    vx, vy = _v("x"), _v("y")
