...
from bourbaki.entiers.ensembles_entiers import (UN, longueur_suite, intervalle_entiers)
from bourbaki.entiers.ensembles_infinis import NN
from bourbaki.entiers import ensembles_entiers_notions_suites as S
