...
"""
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import (var, egal, et, impl, appartient, existe, pourtout, inclus, equiv)
from bourbaki.ii_theorie_des_ensembles.ii_1_relations_collectivisantes import ensembles_abrege as E
from bourbaki.ii_theorie_des_ensembles.ii_4_reunion_intersection_famille.ii_4_1_definitions_algebre import ensembles_familles as F
...
def test_membre_inter_famille():
    # ÉNONCÉ RENFORCÉ (migration « ⋂ = sélection dans ⋃ »). Le test assertait
    # l'équivalence INCONDITIONNELLE de la Déf. 2 ; elle est FAUSSE pour I = ∅
    # (membre droit vide-vrai pour tout z, alors que ⋂_{ι∈∅} X_ι = ∅), et c'est
    # cette forme qui rendait theorie_ensembles() contradictoire. Le théorème
    # porte donc maintenant l'hypothèse que Bourbaki écrit (E II.22, PDF p.73 :
    # « … dont l'ensemble d'indices I n'est pas vide »), soit (∃i)(i∈I).
    vf, vI, vz, vi = var("f"), var("I"), var("z"), var("i")
    cible = impl(existe("i", appartient(vi, vI)),
                 equiv(appartient(vz, E.inter_famille(vf, vI)),
