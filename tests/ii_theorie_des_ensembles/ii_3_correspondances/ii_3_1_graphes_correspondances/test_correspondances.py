...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import var, egal, impl, equiv, appartient, existe, pourtout, non, inclus as inclus_
from bourbaki.ii_theorie_des_ensembles.ii_1_relations_collectivisantes.ensembles_abrege import (est_un_graphe, dom, img, image, couple, singleton,
                              VIDE, est_un_couple)
from bourbaki.ii_theorie_des_ensembles.ii_3_correspondances.ii_3_1_graphes_correspondances.ensembles_correspondances import (image_croissante, image_dans_img, image_vide,
                                       coupe_membre)
