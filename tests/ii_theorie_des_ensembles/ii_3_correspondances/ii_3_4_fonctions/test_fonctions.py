...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import var, egal, et, equiv, appartient, existe, pourtout, impl
from bourbaki.ii_theorie_des_ensembles.ii_1_relations_collectivisantes.ensembles_abrege import est_fonctionnel, valeur, couple
...
def test_composee_fonctionnelle():
    from bourbaki.ii_theorie_des_ensembles.ii_1_relations_collectivisantes.ensembles_abrege import composee
...
def test_composition_valeur():
    from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import existe, appartient
    from bourbaki.ii_theorie_des_ensembles.ii_1_relations_collectivisantes.ensembles_abrege import composee, valeur, couple
