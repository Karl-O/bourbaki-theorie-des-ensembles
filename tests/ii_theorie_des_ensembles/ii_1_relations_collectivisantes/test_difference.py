...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import var, egal, et, non, appartient, equiv
from bourbaki.ii_theorie_des_ensembles.ii_1_relations_collectivisantes.ensembles_abrege import difference, reunion, intersection
from bourbaki.ii_theorie_des_ensembles.ii_1_relations_collectivisantes.ensembles_difference import de_morgan_reunion, de_morgan_inter
from bourbaki.i_description_mathematique_formelle.i_2_theoremes.tactiques.tactiques_abrege2 import demorgan_ou, demorgan_et, et_ou_distrib
