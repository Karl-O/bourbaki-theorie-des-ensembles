...
from bourbaki.i_description_mathematique_formelle.i_1_termes_relations.outil_formule import var, egal, inclus, et, impl, ou, non, appartient, equiv, pourtout, coll, afficher_f
from bourbaki.ii_theorie_des_ensembles.ii_1_relations_collectivisantes.ensembles_abrege import paire, singleton, VIDE, reunion, intersection, theorie_ensembles
from bourbaki.ii_theorie_des_ensembles.ii_1_relations_collectivisantes.ensembles_theoremes import (extensionnalite_appliquee, existence_paire,
