"""Tests ISOLÉS du module NEUF `bourbaki.iv_structures.iv_1_structures_isomorphismes.ensembles_transport_iso_props`
...
import bourbaki.iv_structures.iv_1_structures_isomorphismes.ensembles_transport_iso_props as P
