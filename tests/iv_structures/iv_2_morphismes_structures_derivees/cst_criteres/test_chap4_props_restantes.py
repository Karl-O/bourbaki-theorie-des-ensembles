"""Tests ISOLÉS — `bourbaki.iv_structures.iv_2_morphismes_structures_derivees.cst_criteres.ensembles_chap4_props_restantes`.
...
from bourbaki.iv_structures.iv_2_morphismes_structures_derivees.cst_criteres import ensembles_chap4_props_restantes as M
