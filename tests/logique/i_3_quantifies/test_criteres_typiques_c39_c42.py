...
"""
from bourbaki.logique.i_1_termes_relations.formule import (var, non, et, ou, impl, equiv,
                     existe, appartient)
from bourbaki.logique.i_3_quantifies.criteres_typiques_c39_c42 import (
