...
from formule import var, egal, et, impl, appartient, existe, pourtout, inclus
...
from tactiques_abrege_quantif import monotonie_existe, monotonie_pour_tout
from ensembles_theoremes import vide_sans_element
