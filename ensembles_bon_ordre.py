...
from formule import Terme, var, et, ou, appartient
import noyau_abrege as N
import ensembles_abrege as E
from tactiques_abrege import syllogisme
from tactiques_abrege2 import (instancie, conjonction_intro,
                               conjonction_elim_gauche, conjonction_elim_droite,
                               projection_gauche, projection_droite,
                               equivalence_avant, equivalence_arriere)
from ensembles_theoremes import _instance_reunion, _instance_intersection
...
def reunion_segments_segment(R, A="A", B="B", e="E", x="x", y="y"):
    ...
    from tactiques_abrege2 import cas
    vA, vB, ve = _terme(A), _terme(B), _terme(e)
    vx, vy = var(x), var(y)
