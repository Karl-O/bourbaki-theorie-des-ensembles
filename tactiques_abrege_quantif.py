...
from formule import var, non, et, impl, existe, pourtout, tau, subst_f, libres_f
import noyau_abrege as N
from tactiques_abrege import antecedent_consequent, syllogisme
from tactiques_abrege2 import (instanciation_en_x, instanciation, instancie, contraposition,
...
def existe_vacuous(c, x):
    ...
    if x in __import__("formule").libres_f(c):
