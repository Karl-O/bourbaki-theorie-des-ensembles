...
def _selecteur_valeur(f, g, w, gauche=True):
    ...
    from ensembles_projections import tau_egal
...
def _ou_commute_gd(gd, cond2):
    ...
    from tactiques_abrege2 import comm_ou
...
def somme_graphe_injective(f="F", g="G", a="A", b="B"):
    ...
    from ensembles_somme_disjointe import membre_somme_caracterise
    from ensembles_somme_disjointe import _ou_congruence
...
def _somme_image_backward(f, g, a, b, a1, b1, vz, K, AB, A1B1, T,
    ...
    from ensembles_produit_equipotence import _antecedent_image, _valeur_cy
    from ensembles_somme_disjointe import (membre_somme_caracterise, _ou_congruence,
                                           injection_gauche_dans_somme,
                                           injection_droite_dans_somme)
    from ensembles_fonctions import valeur_caracterisation
    from tactiques_abrege_quantif import alpha_existe as _ax
...
def _val_cy_eq(fF, t1, t2, eq_c):
    ...
    from ensembles_produit_equipotence import _valeur_cy
...
def somme_graphe_image(f="F", g="G", a="A", b="B", a1="A1", b1="B1"):
    ...
    from ensembles_produit_equipotence import _valeur_dans_image, _antecedent_image
    from ensembles_somme_disjointe import membre_somme_caracterise, _ou_congruence
    from ensembles_fonctions import valeur_caracterisation
    from tactiques_abrege_quantif import alpha_existe as _ax
    vF, vG = _t(f), _t(g)
