...
from formule import (var, Terme, egal, et, non, impl, equiv, appartient, pourtout)
import noyau_abrege as N
import ensembles_abrege as E
from ensembles_cardinaux import cardinal, est_cardinal, inf_egal_card
from ensembles_entiers import est_fini, est_fini_ensemble, successeur
from tactiques_abrege import a_implique_a
from tactiques_abrege2 import (instancie, equivalence_avant, dni,
                               conjonction_intro,
