...
import noyau
from tactiques_prop import conjonction_intro
from tactiques_egalite import instanciation_en_x
from congruence_quantif import monotonie_existe, congruence_existe
