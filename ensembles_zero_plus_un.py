...
from formule import (Terme, var, egal, et, non, appartient, existe, subst_t, subst_f)
...
def somme_zero_un_egale_singleton():
    ...
    from ensembles_somme_disjointe import (somme_disjointe, membre_somme_caracterise,
                                           ZERO, UN)
    vide = E.VIDE
