...
from formule import var, egal, et, existe, pourtout, appartient
...
from tactiques_abrege2 import (conjonction_intro, conjonction_elim_gauche,
                               ...
                               instancie)
from tactiques_abrege_egalite import symetrie as eg_symetrie
from ensembles_cardinaux import est_bijection_de
from ensembles_equipotence import (diagonale_fonctionnelle, diagonale_domaine,
...
def compatible(f, e, r, rp, x="a", y="b"):
    ...
    from formule import impl, equiv
