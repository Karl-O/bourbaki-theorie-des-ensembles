...
\paragraph{Le dernier kilomètre, défini.} Nous empruntons le terme à la logistique, où
il nomme le dernier tronçon d'une livraison --- court, démesurément coûteux, et celui
qu'aucun investissement dans le réseau principal ne raccourcit. En recherche de preuve,
il nomme ceci~:

\begin{quote}
Étant donné un but, une recherche dérive ce qu'elle peut, puis s'arrête. \textbf{Le
dernier kilomètre est la distance entre ce qu'elle a dérivé et ce qui était demandé} ---
le tronçon où la recherche mécanisée a fait tout ce qu'elle sait faire et où le but
reste ouvert.
\end{quote}

Trois propriétés en font un problème à part entière, et non simplement « la partie
difficile ». Il n'est \emph{pas proportionnel à l'effort}~: doubler le budget ne le
divise pas par deux, parce que ce qui manque d'ordinaire n'est pas plus de recherche
mais un objet d'une autre nature --- un témoin que le pool n'a jamais nommé, une loi à
une instance que personne n'a engendrée. Il n'est \emph{pas visible}~: un délai dépassé
a la même tête qu'il manque un lemme ou une théorie entière. Et c'est \emph{là que
l'humain reprend la main} --- ce qui est précisément pourquoi le laisser sans
description coûte cher~: la personne qui reprend le travail doit redécouvrir ce que la
machine savait déjà et a jeté.
...
((a+b)+1)+c &=& (a+b)+(1+c) & \text{associativité itérée} \\[2pt]
            &=& (a+b)+(c+1) & \text{commutativité, \emph{dans} l'opérande droit} \\[2pt]
