...
On lit parfois $(\exists x)\varphi(x) = \varphi(\tau x\,\varphi)$. Tout y est fautif~:
$\varphi$ n'est pas une fonction qu'on applique~; « $\tau x\,\varphi$ » laisse croire que
$x$ figure encore dans le terme, alors que la définition~\ref{def:tau} vient de l'en
effacer~; et le signe $=$ n'est pas disponible ici (remarque~\ref{rem:signes}). La forme
correcte est celle de substitution ci-dessus.
\end{remarque}
