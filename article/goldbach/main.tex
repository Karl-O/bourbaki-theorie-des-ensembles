...
reductions are now measured (Section~\ref{sec:overclaim}), but ``major'' is our
judgement. Smaller links of the chain --- the $\tau$ bridge, the bounded arc absorbed by
GG25 --- have not been re-derived parametrically, and we do not claim they are free of
arithmetic. The honest statement is that every reduction we identified as load-bearing
has been measured, not that the entire eighteen-link chain has.
