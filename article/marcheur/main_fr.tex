...
descendre. Mais $\mathrm{succ}(\text{somme})$ n'était dans aucune entrée, si
bien que \emph{toute} conjecture sur une opération dérivée s'évaluait en
...
%% A REMPLIR (P6) : traduire la section anglaise une fois la mesure faite.
...
%% A REMPLIR : verdict de la suite de tests marcheur (derniere ligne).
