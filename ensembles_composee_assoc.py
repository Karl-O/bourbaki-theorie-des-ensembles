...
from tactiques_abrege2 import (equivalence_transitivite, equivalence_avant,
                               antecedent_consequent, et_congruence_droite,
                               et_congruence_gauche, assoc_et, instancie)
from tactiques_abrege_quantif import (congruence_existe, et_existe_droite,
                                      et_existe_gauche, existe_commute, alpha_existe)
from ensembles_composee import couple_composee, _inst_composee
