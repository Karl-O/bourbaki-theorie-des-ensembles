...
from lecture import DEFAUT
import noyau
from tactiques import a_implique_a, syllogisme, mono_gauche, mono_droite
from tactiques_prop import (double_negation_intro, double_negation_elim,
...
def c25_second(thm_non_a, b, sig=DEFAUT):
    ...
    from lecture import depuis_assemblage, vers_assemblage
